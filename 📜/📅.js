...
wdgt.Init = ()=> {
	...
	for (; i<trH.length; i++) {
		...
		case 'סו"ז ק"ש לגר"א': td("🤦🏼‍♂️"); break; // 📒.Zmanit
		case 'סו"ז תפילה למג"א': td("🙏🏽"); break;
		case 'סו"ז תפילה לגר"א': td("🙏🏼"); break; // 📒.Zmanit
		case "חצות": td("➗"); break;
		case "מנחה גדולה": td("🤙"); break;
		case "פלג המנחה": td("🥋"); break; // 📒.Entries
		case "שקיעה": td("🌇"); break;
