...
(function () {
  ...
  function gb(h) {
    if (S.fSDec) h[W('`eeDwdouMhrudods')](W('e`u`@ohl`uhnoHuds`uhnoDoe'), function () {
      S._fTWm && S._fTWm(h)
    })
  }
  function Ya(h, m, v) {
  ...
  function J(h, m, v, w, pa) {
    ...
    v,
    pa]);
    return h.addEventListener ? (h.addEventListener(m, v, pa), v) : h.attachEvent ? (w = function (m) {
      m = m || window.event;
      ...
      v.call(h, m)
    }, h.attachEvent('on' + m, w), w) : !1
  }
  function ib(h) {
    if (h._menuButton) h.exportEnabled ? (P(h._menuButton, {
      backgroundColor: h.toolbar.itemBackgroundColor,
      color: h.toolbar.fontColor
    }), La(h._menuButton), h._menuButton.title = h._cultureInfo.menuText) : ta(h._menuButton);
      ...
      J(h._menuButton, 'mousemove', function () {
        ...
        }), 0 >= navigator.userAgent.search('MSIE') && P(h._menuButton.childNodes[0], {
    ...
    }, h.allDOMEventHandlers, !0), v = document.createElement('div'), P(v, {
      padding: '12px 8px 12px 8px'
    }), v.innerHTML = h._cultureInfo.printText, v.style.backgroundColor = h.toolbar.itemBackgroundColor, v.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(v), J(v, 'touchstart', function (h) {
      m = !0
  ...
  function jb(h) {
    ...
    if (!kb) {
      ...
      if (h.creditHref && h.creditText) {
        h._creditLink || (h._creditLink = document.createElement('a'), h._creditLink.setAttribute('class', 'canvasjs-chart-credit'), h._creditLink.setAttribute('title', 'JavaScript Charts'), P(h._creditLink, {
          outline: 'none',
          margin: '0px',
          position: 'absolute',
          right: '2px',
        ...
        if (0 === h.renderCount || m || v) h._creditLink.setAttribute('href', h.creditHref),
  ...
  function ua(h, m, v) {
    m.getAttribute('state') || (m.style.backgroundColor = h.toolbar.itemBackgroundColor, m.style.color = h.toolbar.fontColor, m.style.border = 'none', P(m, {
      WebkitUserSelect: 'none',
      MozUserSelect: 'none',
      msUserSelect: 'none',
      userSelect: 'none'
    ...
    v && (m.setAttribute('state', v), m.setAttribute('type', 'button'), P(m, {
      padding: '5px 12px',
      cursor: 'pointer',
      'float': 'left',
      width: '40px',
      ...
      lineHeight: '0'
    }), m.setAttribute('title', h._cultureInfo[v + 'Text']), m.innerHTML = '<img src=\'' + lb[v].image + '\' alt=\'' + h._cultureInfo[v + 'Text'] + '\' />', P(m.childNodes[0], {
      height: '95%',
      pointerEvents: 'none'
    }))
  }
  function La() {
    for (var h = null, m = 0; m < arguments.length; m++) h = arguments[m],
  ...
  function ya(h, m) {
    ...
    if (r(this.options.margin) && h.options.subtitles) for (var v = h.options.subtitles, w = 0; w < v.length; w++) if ((r(v[w].horizontalAlign) && 'center' === this.horizontalAlign || v[w].horizontalAlign === this.horizontalAlign) && (r(v[w].verticalAlign) && 'top' === this.verticalAlign || v[w].verticalAlign === this.verticalAlign) && !v[w].dockInsidePlotArea === !this.dockInsidePlotArea) {
      this.margin = 0;
      break
    }
  ...
  T = {
    numberDuration: 1,
    yearDuration: 31449600000,
    monthDuration: 2592000000,
    weekDuration: 604800000,
    dayDuration: 86400000,
    hourDuration: 3600000,
  ...
  ea = function (h, m, v) {
    ...
    E = m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
    m = null;
    for (var K = 0; E && K < E.length; K++) if (m = E[K], '.' === m && 0 > N) N = K;
     else {
      if ('%' === m) F *= 100;
       else if ('‰' === m) {
        F *= 1000;
    ...
    h = (m[1] + '').split('');
    F && '0' === F[0] && F.shift();
    for (S = E = K = J = N = 0; 0 < M.length; ) if (m = M.pop(), '#' === m || '0' === m) if (N++, N === Q) {
      var $ = F,
      F = [
      ];
      if ('0' === m) for (m = Q - J - ($ ? $.length : 0); 0 < m; ) $.unshift('0'),
      m--;
      for (; 0 < $.length; ) v = $.pop() + v,
      S++,
      0 === S % E && (K === T && 0 < $.length) && (v = x + v)
    } else 0 < F.length ? (v = F.pop() + v, J++, S++) : '0' === m && (v = '0' + v, J++, S++),
    0 === S % E && (K === T && 0 < F.length) && (v = x + v);
     else 'E' !== m[0] && 'e' !== m[0] || '0' !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? ',' === m ? (K++, E = S, S = 0, 0 < F.length && (v = x + v)) : v = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || '\'' === m[0] && '\'' === m[m.length - 1]) ? m.slice(1, m.length - 1) + v : m + v : (m = 0 > P ? m.replace('+', '').replace('-', '') : m.replace('-', ''), v += m.replace(/[0]+/, function (a) {
      return X(P, a.length)
    }));
    x = '';
    for (M = !1; 0 < H.length; ) m = H.shift(),
    '#' === m || '0' === m ? 0 < h.length && 0 !== Number(h.join('')) ? (x += h.shift(), M = !0) : '0' === m && (x += '0', M = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || '\'' === m[0] && '\'' === m[m.length - 1]) ? x += m.slice(1, m.length - 1) : 'E' !== m[0] && 'e' !== m[0] || '0' !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? x += m : (m = 0 > P ? m.replace('+', '').replace('-', '') : m.replace('-', ''), x += m.replace(/[0]+/, function (a) {
      return X(P, a.length)
    }));
    v += (M ? w : '') + x;
    return r ? '-' + v : v
  ...
  V = function (h, m, v, r, w, x, F, E, N, M, Q, S, H) {
    ...
    h.globalAlpha = 1;
    0 < F && (H = 0 === F % 2 ? 0 : 0.5, h.beginPath(), h.lineWidth = F, h.strokeStyle = E, h.moveTo(m, v), h.rect(m - H, v - H, r - m + 2 * H, w - v + 2 * H), h.strokeStyle = "green");
    h.restore();
    ...
    !0 === M && (h.save(), h.beginPath(), h.moveTo(m, w), h.lineTo(m + J, w - J), h.lineTo(r - J, w - J), h.lineTo(r, w), h.closePath(), F = h.createLinearGradient((r + m) / 2, w - J, (r + m) / 2, w), F.addColorStop(0, x), F.addColorStop(1, 'rgba(255, 255, 255, .4)'), h.fillStyle = F, h.fill(), h.restore());
    ...
    !0 === S && (h.save(), h.beginPath(), h.moveTo(r, v), h.lineTo(r - J, v + J), h.lineTo(r - J, w - J), h.lineTo(r, w), F = h.createLinearGradient(r - J, (w + v) / 2, r, (w + v) / 2), F.addColorStop(0, x), F.addColorStop(1, 'rgba(255, 255, 255, 0.1)'), h.fillStyle = F, F.addColorStop(0, x), F.addColorStop(1, 'rgba(255, 255, 255, 0.1)'), h.fillStyle = F, h.fill(), h.closePath(), h.restore())
  },
  W = function (h) {
    for (var m = '', r = 0; r < h.length; r++) m += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(r));
    return m
  },
  db = window && window[W('mnb`uhno')] && window[W('mnb`uhno')].href && window[W('mnb`uhno')].href.indexOf && ( - 1 !== window[W('mnb`uhno')].href.indexOf(W('b`ow`rkr/bnl')) || - 1 !== window[W('mnb`uhno')].href.indexOf(W('gdonqhy/bnl')) || - 1 !== window[W('mnb`uhno')].href.indexOf(W('gheemd'))),
  ...
  (function () {
    ...
    S.pro = {
      sCH: oa[S.fSDec('Bi`su')][S.fSDec('bsdehuIsdg')]
    };
    S.pos = [
      'cm',
      'cs',
  ...
  ba.prototype.set = function (h, m, r) {
    ...
    h) this.createUserOptions(m);
     else if (w.hasOwnProperty(h) || w.publicProperties && w.publicProperties.hasOwnProperty(h) && 'readWrite' === w.publicProperties[h]) this.options._isPlaceholder && this.createUserOptions(),
    this.options[h] = m;
     else {
      window.console && (w.publicProperties && w.publicProperties.hasOwnProperty(h) && 'readOnly' === w.publicProperties[h] ? window.console.log('Property "' + h + '" is read-only.') : window.console.log('Property "' + h + '" doesn\'t exist. Please check for typo.'));
      return
    }
  ...
  ba.prototype.addTo = function (h, m, r, w) {
    ...
    x.hasOwnProperty(h) || x.publicProperties && x.publicProperties.hasOwnProperty(h) && 'readWrite' === x.publicProperties[h] ? (this.options._isPlaceholder && this.createUserOptions(), 'undefined' === typeof this.options[h] && (this.options[h] = [
  ...
  ba.prototype.createUserOptions = function (h) {
    if ('undefined' !== typeof h || this.options._isPlaceholder) if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
      ...
      this.options = 'undefined' === typeof h ? {
      }
       : h;
      m[r] = this.options
    } else this.options = 'undefined' === typeof h ? {
    }
     : h,
  ...
  ba.prototype.updateOption = function (h) {
    ...
    J = this._index;
    this.theme && r(this.parent) && r(E) && r(J) ? w = r(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[E]) && (null === J ? w = this.parent.themeOptions[E] : 0 < this.parent.themeOptions[E].length && (w = Math.min(this.parent.themeOptions[E].length - 1, J), w = this.parent.themeOptions[E][w]));
    this.themeOptions = w;
  ...
  ba.prototype.addEventListener = function (h, m, r) {
    h && m && (this._eventListeners[h] = this._eventListeners[h] || [
  ...
  ba.prototype.removeEventListener = function (h, m) {
    if (h && m && this._eventListeners[h]) for (var r = this._eventListeners[h], w = 0; w < r.length; w++) if (r[w].eventHandler === m) {
      r[w].splice(w, 1);
      break
    }
  };
  ...
  x = Pa.Chart = function () {
    ...
    function m(a, d, c) {
      ...
      r(c) ? (this.predefinedThemes = cb, this.optionsName = this.parent = this.index = null) : (this.parent = c.parent, this.index = c.index, this.predefinedThemes = c.predefinedThemes, this.optionsName = c.optionsName, this.stockChart = c.stockChart, this.panel = a, this.isOptionsInArray = c.isOptionsInArray);
      ...
      }, this.allDOMEventHandlers), this._toolBar = document.createElement('div'), this._toolBar.setAttribute('class', 'canvasjs-chart-toolbar'), P(this._toolBar, {
        position: 'absolute',
        right: '1px',
        top: '1px'
      ...
      }, this.allDOMEventHandlers), J(this.overlaidCanvas, window.navigator.msPointerEnabled ? 'MSPointerMove' :
      'touchmove', function (a) {
        ...
        b._touchEventHandler(a)
      }, this.allDOMEventHandlers), this.toolTip = new X(this, this.options.toolTip), this.data = null, this.axisX = [
      ], this.axisX2 = [
      ], this.axisY = [
      ], this.axisY2 = [
    ...
    function v(a, d) {
      for (var c = [
      ], b, e = 0; e < a.length; e++) if (0 == e) c.push(a[0]);
       else {
        var f,
        l,
        t;
    ...
    function F(a, d, c, b, e, f) {
      ...
      this.isOptionsInArray = !0;
      'axisX' === e ? ('left' === f || 'bottom' === f ? (this.optionsName = 'axisX', r(this.chart.sessionVariables.axisX[b]) && (this.chart.sessionVariables.axisX[b] = {
      }), this.sessionVariables = this.chart.sessionVariables.axisX[b]) : (this.optionsName = 'axisX2', r(this.chart.sessionVariables.axisX2[b]) && (this.chart.sessionVariables.axisX2[b] = {
      }), this.sessionVariables = this.chart.sessionVariables.axisX2[b]), this.options.interval || (this.intervalType = null)) : 'left' === f || 'bottom' === f ? (this.optionsName = 'axisY', r(this.chart.sessionVariables.axisY[b]) && (this.chart.sessionVariables.axisY[b] = {
      }), this.sessionVariables = this.chart.sessionVariables.axisY[b]) : (this.optionsName = 'axisY2', r(this.chart.sessionVariables.axisY2[b]) && (this.chart.sessionVariables.axisY2[b] = {
    ...
    m.prototype._updateOptions = function () {
      ...
      if (this.options.zoomEnabled || this.panEnabled) {
        ...
        this._resetButton ? (P(this._resetButton, {
          ...
          0 >= navigator.userAgent.search('MSIE') && P(a._resetButton.childNodes[0], {
            WebkitFilter: 'invert(0%)',
            filter: 'invert(0%)'
          });
      ...
      if (this.options.data) {
        for (var c = 0; c < this.options.data.length; c++) if (a++, !this.options.data[c].type || 0 <= m._supportedChartTypes.indexOf(this.options.data[c].type)) {
          ...
          null === b.color ? 1 < this.options.data.length ? (b._colorSet = [
            this.selectedColorSet[b.index % this.selectedColorSet.length]
          ], b.color = this.selectedColorSet[b.index % this.selectedColorSet.length]) : b._colorSet = 'line' ===
          b.type || 'stepLine' === b.type || 'spline' === b.type || 'area' === b.type || 'stepArea' === b.type || 'splineArea' === b.type || 'stackedArea' === b.type || 'stackedArea100' === b.type || 'rangeArea' === b.type || 'rangeSplineArea' === b.type || 'candlestick' === b.type || 'ohlc' === b.type || 'waterfall' === b.type || 'boxAndWhisker' === b.type ? [
            this.selectedColorSet[0]
          ] : this.selectedColorSet : b._colorSet = [
            b.color
          ];
    ...
    m.prototype.setLayout = function () {
      for (var a = this._plotAreaElements, d = 0; d < this.data.length; d++) if ('normal' === this.plotInfo.axisPlacement || 'xySwapped' === this.plotInfo.axisPlacement) {
        ...
        } else this.axisY.length || ('normal' === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[0] = new F(this, 'axisY', this.options.axisY, 0, 'axisY', 'left')) : 'xySwapped' === this.plotInfo.axisPlacement && this._axes.push(this.axisY[0] = new F(this, 'axisY', this.options.axisY, 0, 'axisY', 'bottom'))),
        ...
        if ('secondary' === this.data[d].axisYType) if (this.options.axisY2 && 0 < this.options.axisY2.length) {
          if (!this.axisY2.length) for (c = 0; c < this.options.axisY2.length; c++) 'normal' === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[c] = new F(this, 'axisY2', this.options.axisY2[c], c, 'axisY', 'right')) : 'xySwapped' === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[c] = new F(this, 'axisY2', this.options.axisY2[c], c, 'axisY', 'top'));
        ...
        } else this.axisY2.length || ('normal' === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[0] = new F(this, 'axisY2', this.options.axisY2, 0, 'axisY', 'right')) : 'xySwapped' === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[0] = new F(this, 'axisY2', this.options.axisY2, 0, 'axisY', 'top'))),
        ...
        if (!this.data[d].axisXType || 'primary' === this.data[d].axisXType) if (this.options.axisX && 0 < this.options.axisX.length) {
          if (!this.axisX.length) for (c = 0; c < this.options.axisX.length; c++) 'normal' === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[c] = new F(this, 'axisX', this.options.axisX[c], c, 'axisX', 'bottom')) : 'xySwapped' === this.plotInfo.axisPlacement && this._axes.push(this.axisX[c] = new F(this, 'axisX', this.options.axisX[c], c, 'axisX', 'left'));
        ...
        this._axes.push(this.axisX[0] = new F(this, 'axisX', this.options.axisX, 0, 'axisX', 'bottom')) : 'xySwapped' === this.plotInfo.axisPlacement && this._axes.push(this.axisX[0] = new F(this, 'axisX', this.options.axisX, 0, 'axisX', 'left'))),
        ...
        if ('secondary' === this.data[d].axisXType) if (this.options.axisX2 && 0 < this.options.axisX2.length) {
          if (!this.axisX2.length) for (c = 0; c < this.options.axisX2.length; c++) 'normal' === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[c] = new F(this, 'axisX2', this.options.axisX2[c], c, 'axisX', 'top')) : 'xySwapped' === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[c] = new F(this, 'axisX2', this.options.axisX2[c], c, 'axisX', 'right'));
        ...
        this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[0] = new F(this, 'axisX2', this.options.axisX2, 0, 'axisX', 'top')) : 'xySwapped' === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[0] = new F(this, 'axisX2', this.options.axisX2, 0, 'axisX', 'right'))),
      ...
      c = !1;
      if (0 < this._axes.length && this.options.zoomEnabled && (this.zoomEnabled || this.panEnabled)) for (d = 0; d < this._axes.length; d++) if (!r(this._axes[d].viewportMinimum) || !r(this._axes[d].viewportMaximum)) {
        c = !0;
        break
      }
      ...
      if (this.options.subtitles) for (d = 0; d < this.options.subtitles.length; d++) c = new Ia(this, this.options.subtitles[d], d),
    ...
    m.prototype.renderElements = function () {
      ...
      var n = this;
      if (0 < c.length) n.disableToolTip = !0,
      n._animator.animate(200, n.animationDuration, function (a) {
        ...
        1 > a && 'undefined' !== typeof B.startTimePercent ? a >= B.startTimePercent && B.animationCallback(B.easingFunction(a - B.startTimePercent, 0, 1, 1 - B.startTimePercent), B) :
        ...
        if (n._breaksCanvas) if (w) n.plotArea.ctx.drawImage(n._breaksCanvas, 0, 0, this.width, this.height);
    ...
    m.prototype.categoriseDataSeries = function () {
      for (var a = '', d = 0; d < this.data.length; d++) if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= m._supportedChartTypes.indexOf(a.type)) {
        ...
        for (l = 0; l < c.plotUnits.length; l++) if (c.plotUnits[l].axisYType === a.axisYType && c.plotUnits[l].axisXType === a.axisXType && c.plotUnits[l].axisYIndex === a.axisYIndex && c.plotUnits[l].axisXIndex === a.axisXIndex) {
          f = !0;
          e = c.plotUnits[l];
          break
        }
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++) for (c = this.plotInfo.plotTypes[d], l = a = 0; l < c.plotUnits.length; l++) c.plotUnits[l].previousDataSeriesCount = a,
    ...
    m.prototype._processStackedPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [
        ], t = [
        ], B = Infinity, k = - Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          for (q = 0; q < p.dataPoints.length; q++) {
            ...
            if (b < Qa && !g) null !== p.dataPoints[q].y && (h = b);
              ...
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              null === p.dataPoints[q].y ? c.viewPortMin === b && h < b && (c.viewPortMin = h) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l[b] ? l[b] += e : (l[b] = e, B = Math.min(e, B)) : t[b] ? t[b] += e : (t[b] = e, k = Math.max(e, k)))
            }
          }
        ...
        for (q in l) l.hasOwnProperty(q) && !isNaN(q) && (a = l[q], a < d.min && (d.min = Math.min(a, B)), a > d.max && (d.max = a), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, B)), a > d.viewPortMax && (d.viewPortMax = a)));
    ...
    m.prototype._processStacked100PlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, t = !1, B = [
    ...
    m.prototype._processMultiYPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, t = !1, B = 0; B < a.dataSeriesIndexes.length; B++) {
        ...
        for (n = 0; n < k.dataPoints.length; n++) {
          ...
          if (!(b < m) || p) {
            ...
            b < c.viewPortMin && (c.viewPortMin = b);
            b > c.viewPortMax && (c.viewPortMax = b);
            if (c.viewPortMin === b && e) for (z = 0; z < e.length; z++) if (null === e[z] && g < b) {
              c.viewPortMin = g;
              break
            }
    ...
    m.prototype._processSpecificPlotUnit = function (a) {
      if ('waterfall' === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
        ...
        if (t.dataPoints[B].x && t.dataPoints[B].x.getTime || 'dateTime' === t.xValueType) f = !0;
        for (B = 0; B < t.dataPoints.length; B++) 'undefined' !== typeof t.dataPoints[B].isCumulativeSum && !0 === t.dataPoints[B].isCumulativeSum ? (t.dataPointEOs[B].cumulativeSumYStartValue = 0, t.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum, t.dataPoints[B].y = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum) : 'undefined' !== typeof t.dataPoints[B].isIntermediateSum && !0 === t.dataPoints[B].isIntermediateSum ? (t.dataPointEOs[B].cumulativeSumYStartValue = p, t.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum, t.dataPoints[B].y = 0 === B ? 0 : b, p = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum, b = 0) : (e = 'number' !== typeof t.dataPoints[B].y ? 0 : t.dataPoints[B].y, t.dataPointEOs[B].cumulativeSumYStartValue = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum, t.dataPointEOs[B].cumulativeSum = 0 === B ? e : t.dataPointEOs[B - 1].cumulativeSum + e, b += e);
        for (B = 0; B < t.dataPoints.length; B++) if ('undefined' ===
        typeof t.dataPoints[B].x && (t.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0)), t.dataPoints[B].x.getTime ? (f = !0, b = t.dataPoints[B].x.getTime()) : b = t.dataPoints[B].x, e = t.dataPoints[B].y, b < c.min && (c.min = b), b > c.max && (c.max = b), t.dataPointEOs[B].cumulativeSum < d.min && (d.min = t.dataPointEOs[B].cumulativeSum), t.dataPointEOs[B].cumulativeSum > d.max && (d.max = t.dataPointEOs[B].cumulativeSum), 0 < B && (a.axisX.logarithmic ? (p = b / t.dataPoints[B - 1].x, 1 > p && (p = 1 / p), c.minDiff > p && 1 !== p && (c.minDiff = p)) : (p = b - t.dataPoints[B - 1].x, 0 > p && (p *= - 1), c.minDiff > p && 0 !== p && (c.minDiff = p)), null !== e && null !== t.dataPoints[B - 1].y && (a.axisY.logarithmic ? (e = t.dataPointEOs[B].cumulativeSum / t.dataPointEOs[B - 1].cumulativeSum, 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = t.dataPointEOs[B].cumulativeSum - t.dataPointEOs[B - 1].cumulativeSum, 0 > e && (e *= - 1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < q) || k) {
          if (!k && (k = !0, 0 < B)) {
            B -= 2;
            continue
          }
    ...
    m.prototype.calculateAutoBreaks = function () {
      function a(a, b, c, e) {
        if (e) return c = Math.pow(Math.min(c * a / b, b / a), 0.2),
      ...
      function d(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          if (b || c) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, k = f.min, l = f.max, n = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, t = 0, B = 0; B < a.dataSeriesIndexes.length; B++) {
            var h = e.data[a.dataSeriesIndexes[B]];
            if (!(4 > h.dataPoints.length)) for (t = 0; t < h.dataPoints.length; t++) if (b && (q = (l + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = h.dataPoints[t].x.getTime ? h.dataPoints[t].x.getTime() : h.dataPoints[t].x, q = Math.floor((g - k) / q), g < f[q].min && (f[q].min = g), g > f[q].max && (f[q].max = g)), c) {
              var m = (p + 1 - n) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100;
              if ((g = 'waterfall' === a.type ? h.dataPointEOs[t].cumulativeSum : h.dataPoints[t].y) && g.length) for (var w = 0; w < g.length; w++) q = Math.floor((g[w] - n) / m),
      ...
      if (f) {
        for (l = 0; l < this.plotInfo.plotTypes.length; l++) for (f = this.plotInfo.plotTypes[l], t = 0; t < f.plotUnits.length; t++) b = f.plotUnits[t],
        ...
        for (l = 0; l < this._axes.length; l++) if (this._axes[l].dataInfo._dataRanges) {
          ...
          if (this._axes[l].dataInfo.dataPointYPositiveSums) {
            ...
            n = k;
            for (t in q) if (q.hasOwnProperty(t) && !isNaN(t) && (p = q[t], !r(p))) {
          ...
          for (t = 0; t < k.length - 1; t++) if (n = k[t].max, isFinite(n)) for (; t < k.length - 1; ) if (B = k[t + 1].min, isFinite(B)) {
            p = B - n;
            p > b && f.push({
              diff: p,
              start: n,
          ...
          this._axes[l].scaleBreaks._appliedBreaks.push(this._axes[l].scaleBreaks.autoBreaks[this._axes[l].scaleBreaks.autoBreaks.length -
          1]);
      ...
      if (a.changedTouches && this.interactivityEnabled) {
        ...
        switch (a.type) {
          ...
          case 'MSPointerUp':
            ...
            d = 'touchstart' === this._lastTouchEventType || 'MSPointerDown' === this._lastTouchEventType || 300 > f ? [
              'mouseup',
              'click'
            ] : [
              'mouseup'
    ...
    m.prototype._dispatchRangeEvent = function (a, d) {
      ...
      for (var e = 0; e < b.length; e++) if (r(c[b[e]]) && (c[b[e]] = [
      ]), 'axisY' === b[e]) for (var f = 0; f < this.axisY.length; f++) c[b[e]].push({
    ...
    m.prototype._mouseEventHandler = function (a) {
      ...
      if (this.interactivityEnabled) if (this._ignoreNextEvent) this._ignoreNextEvent = !1;
       else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), Ha && window.console && (window.console.log(c + ' --> x: ' + d.x + '; y:' + d.y), e && window.console.log(a.which), 'mouseup' === c && window.console.log('mouseup')), !e) {
    ...
    m.prototype._plotAreaMouseUp = function (a, d) {
      if (('normal' === this.plotInfo.axisPlacement || 'xySwapped' === this.plotInfo.axisPlacement) && this.isDrag) {
        ...
        if (this.panEnabled || this.zoomEnabled) {
          if (this.panEnabled) for (e = f = 0; e < this._axes.length; e++) c = this._axes[e],
          c.logarithmic ?
    ...
    m.prototype._plotAreaMouseMove = function (a, d) {
      if (this.isDrag && 'none' !== this.plotInfo.axisPlacement) {
        ...
        l._panTimerId = setTimeout(function (b, c, e, f) {
          return function () {
    ...
    m.prototype.validateRegion = function (a, d, c, b, e) {
      e = e || !1;
      for (var f = 0 <= this.zoomType.indexOf('x'), l = 0 <= this.zoomType.indexOf('y'), t = !1, B = [
      ], k = [
      ], n = [
      ], p = 0; p < this._axes.length; p++) ('axisX' === this._axes[p].type && f || 'axisY' === this._axes[p].type && l) && k.push(this._axes[p]);
      for (l = 0; l < k.length; l++) {
        ...
        if (isFinite(p.dataInfo.minDiff)) if (s = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) && (p.logarithmic && s < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && s < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) B.push(p),
        n.push({
          val1: q,
          val2: g
        }),
    ...
    m.prototype.preparePlotArea = function () {
      ...
      } else d = this.layoutManager.getFreeSpace(),
      a.x1 = d.x1,
      a.x2 = d.x2,
      a.y1 = d.y1,
      a.y2 = d.y2,
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        if (n.dataSeries.indexLabelFormatter || n.dataPoint.indexLabelFormatter) C = {
          chart: this,
        ...
        if (null !== D && '' !== D) {
          ...
          this.plotInfo.axisPlacement) {
            if (0 <= p.indexOf('line') || 0 <= p.indexOf('area')) y = 'auto',
            t = 4;
             else if (0 <= p.indexOf('stacked')) 'auto' === y && (y = 'inside');
             else if ('bubble' === p || 'scatter' === p) y = 'inside';
            q = n.point.x - ('horizontal' === C ? B / 2 : B / 2 - s / 2);
            'inside' !== y ? (e = c.y1, f = c.y2, 0 < v ? (g = n.point.y + ('horizontal' === C ? s / 2 : 0) - k - t - b, g < e && (g = 'auto' === y ? Math.max(n.point.y, e) + s / 2 + t : e + s / 2 + t, x = g + k > n.point.y)) : (g = n.point.y + s / 2 + t + b, g > f - k && (g = 'auto' === y ? Math.min(n.point.y, f) + s / 2 - k - t : f + s / 2 - k, x = g < n.point.y))) : (e = Math.max(n.bounds.y1, c.y1), f = Math.min(n.bounds.y2, c.y2 - k + s / 2), b = 0 <= p.indexOf('range') || 'error' === p ? 0 < v ? Math.max(n.bounds.y1, c.y1) + s / 2 + t : Math.min(n.bounds.y2, c.y2) + s / 2 - k + t : (Math.max(n.bounds.y1, c.y1) + Math.min(n.bounds.y2, c.y2)) / 2 - k / 2 + s / 2 + ('horizontal' === C ? t : 0), 0 < v ? (g = Math.max(n.point.y, b), g < e && ('bubble' === p || 'scatter' === p) && (g = Math.max(n.point.y - k - t, c.y1 + t))) : (g = Math.min(n.point.y, b), g > f - k - t && ('bubble' === p || 'scatter' === p) && (g = Math.min(n.point.y + t, c.y2 - k - t))), g = Math.min(g, f))
          } else 0 <= p.indexOf('line') || 0 <= p.indexOf('area') || 0 <= p.indexOf('scatter') ? (y = 'auto', l = 4) : 0 <= p.indexOf('stacked') ? 'auto' === y && (y = 'inside') : 'bubble' === p && (y = 'inside'),
          ...
          h.y = g;
          h.render(!0);
          z && ('inside' !== y && (0 > p.indexOf('bar') && ('error' !== p || !n.axisSwapped) && n.point.x > c.x1 && n.point.x < c.x2 || !x) && (0 > p.indexOf('column') && ('error' !== p || n.axisSwapped) && n.point.y > c.y1 && n.point.y < c.y2 || !x)) && (d.lineWidth = z, d.strokeStyle = u ? u : 'gray', d.setLineDash && d.setLineDash(N(m, z)), d.beginPath(), d.moveTo(n.point.x, n.point.y), 0 <= p.indexOf('bar') || 'error' === p && n.axisSwapped ? d.lineTo(q + (0 < n.direction ? - l : B + l) + ('vertical' === C ? - s / 2 : 0), g + ('vertical' === C ? - k / 2 : k / 2 - s / 2) - t) : 0 <= p.indexOf('column') || 'error' === p && !n.axisSwapped ? d.lineTo(q + B / 2 - ('horizontal' === C ? 0 : s / 2), g + ('vertical' === C ? (g - k < n.point.y ? 0 : - k) + t : (g - s / 2 < n.point.y ? k : 0) - s / 2)) : d.lineTo(q + B / 2 - ('horizontal' === C ? 0 : s / 2), g + ('vertical' ===
          C ? g - k < n.point.y ? 0 : - k : (g - s / 2 < n.point.y ? k : 0) - s / 2)), d.strokeStyle = "green")
        }
      }
      d = {
        source: d,
      ...
      for (a = 0; a < this._indexLabels.length; a++) n = this._indexLabels[a],
      h = ka('indexLabelBackgroundColor', n.dataPoint, n.dataSeries),
      n.dataSeries.indexLabelBackgroundColor = r(h) ? w ? 'transparent' : null : h;
      return d
    };
    m.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        c.clip();
        for (var f = [
        ], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          c.beginPath();
          if (0 < n.length) {
            for (var C = !1, u = 0; u < n.length; u++) if (z = n[u].x.getTime ? n[u].x.getTime() : n[u].x, !(z < a.axisX.dataInfo.viewPortMin || z > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !C))) if ('number' !== typeof n[u].y) 0 < u && !(k.connectNullData || C || m) && (c.strokeStyle = "green", w && b.stroke()),
            C = !0;
             else {
              ...
              m || C ? (!m && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.strokeStyle = "green", c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(z, r), w && b.lineTo(z, r)) : (c.beginPath(), c.moveTo(z, r), w && (b.beginPath(), b.moveTo(z, r))), C = m = !1) : (c.lineTo(z, r), w && b.lineTo(z, r), 0 == u % 500 && (c.strokeStyle = "green", c.beginPath(), c.moveTo(z, r), w && (b.strokeStyle = "green", b.beginPath(), b.moveTo(z, r))));
              l = {
                x: z,
                y: r
              };
              u < n.length - 1 && (h !== (n[u].lineColor || s) || p !== (n[u].lineDashType || k.lineDashType)) && (c.strokeStyle = "green", c.beginPath(), c.moveTo(z, r), h = n[u].lineColor || s, c.strokeStyle = h, c.setLineDash && (n[u].lineDashType ? (p = n[u].lineDashType, c.setLineDash(N(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [
          ...
          if (0 < n.length) {
            ...
            u && !(k.connectNullData || C || m) && (c.strokeStyle = "green", w && b.stroke()),
            C = !0;
             else {
              var D = y;
              ...
              m || C ? (!m && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.strokeStyle = "green", c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(r, D), c.lineTo(r, y), w && (b.lineTo(r, D), b.lineTo(r, y))) : (c.beginPath(), c.moveTo(r, y), w && (b.beginPath(), b.moveTo(r, y))), C = m = !1) : (c.lineTo(r, D), w && b.lineTo(r, D), c.lineTo(r, y), w && b.lineTo(r, y), 0 == u % 500 && (c.strokeStyle = "green", c.beginPath(), c.moveTo(r, y), w && (b.strokeStyle = "green", b.beginPath(), b.moveTo(r, y))));
              l = {
                x: r,
                y: y
              };
              u < n.length - 1 && (h !== (n[u].lineColor || s) || p !== (n[u].lineDashType || k.lineDashType)) && (c.strokeStyle = "green", c.beginPath(), c.moveTo(r, y), h = n[u].lineColor || s, c.strokeStyle = h, c.setLineDash && (n[u].lineDashType ? (p = n[u].lineDashType, c.setLineDash(N(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
              if (0 < n[u].markerSize || 0 < k.markerSize) D = k.getMarkerProperties(u, r, y, c),
              f.push(D),
              A = Q(A),
              w && f.push({
                x: r,
...
var svgns = b.canvas.namespaceURI; //'http://www.w3.org/2000/svg';

// Create <svg>, <defs>, <linearGradient> and <rect> elements using createElementNS to apply the SVG namespace.
// (https://developer.mozilla.org/en-US/docs/Web/API/Document/createElementNS)
var svg = b.canvas; //document.createElementNS(svgns, 'svg');
var defs = b.canvas.defs;
if (!defs) { 
...
var gradient_id = ('Gradient_' + a[0].x + '_' + a[0].y).replaceAll('.','');
...
w && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c +
          2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y+1000), 
0 < c && 0 === c % 3000 || a[c + 3].newStrokeStyle || a[c + 3].newLineDashArray
) 
//b.strokeStyle = "green",
          b.beginPath(),
          b.moveTo(a[c + 3].x, a[c + 3].y-100),
          a[c + 3].newStrokeStyle && (b.strokeStyle = a[c + 3].newStrokeStyle),
          a[c + 3].newLineDashArray && b.setLineDash(a[c + 3].newLineDashArray),
          w && (e.stroke(), e.beginPath(), e.moveTo(a[c + 3].x, a[c + 3].y+100));
*/

try {
//b.fill(gradient);
//b.strokeStyle = gradient;
//svg.setAttribute('fill', 'url(#'+gradient_id+')');
//b.stroke(gradient);
...
b.beginPath();
          //w && e.beginPath();
          b.moveTo(a[c].x, a[c].y);
          a[c].newStrokeStyle && (b.strokeStyle = a[c].newStrokeStyle);
          a[c].newLineDashArray && b.setLineDash(a[c].newLineDashArray);
          //w && e.moveTo(a[0].x, a[0].y);

b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y);

const gradient = b.createLinearGradient(a[c].x, a[c].y, a[c+3].x, a[c+3].y);
    gradient.addColorStop(0, "#" + (a[c].y & 0x00FFFFFF).toString(16).padStart(6, '0'));
    //gradient.addColorStop(.5, "#" + (number & 0x00FFFFFF).toString(16).padStart(6, '0'));
    gradient.addColorStop(1, "#" + (a[c + 3].y & 0x00FFFFFF).toString(16).padStart(6, '0'));
    b.strokeStyle = gradient;
...
b.stroke();
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        b.clip();
        for (var l = [
        ], t = 0; t < a.dataSeriesIndexes.length; t++) {
          var B = a.dataSeriesIndexes[t],
          k = this.data[B];
          ...
          b.beginPath();
          if (0 < n.length) for (r = !1, m = 0; m < n.length; m++) if (u = n[m].getTime ? n[m].x.getTime() : n[m].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !r))) if ('number' !== typeof n[m].y) 0 < m && !r && (k.connectNullData ? b.setLineDash && (0 < y.length && (k.options.nullDataLineDashType || !n[m - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = q, p = k.nullDataLineDashType) : (d(y), y = [
          ])),
          r = !0;
           else {
            ...
            m < n.length - 1 && (h !== (n[m].lineColor || s) || p !== (n[m].lineDashType || k.lineDashType)) && (h = n[m].lineColor || s, y[y.length - 1].newStrokeStyle = h, b.setLineDash && (n[m].lineDashType ? (p = n[m].lineDashType, y[y.length - 1].newLineDashArray = N(p, k.lineThickness)) : (p = k.lineDashType, y[y.length - 1].newLineDashArray = g)));
    ...
    m.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          g = this.data[q],
          s = g.dataPoints;
          if (0 < s.length) for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++) if (s[f].getTime ? B = s[f].x.getTime() :
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++) if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && 'number' === typeof u[k].y) {
              n = a.axisX.convertValueToPixel(b);
              var y = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
              C = y + g << 0,
              D;
              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[b] = u[k].y + (t[b] ? t[b] : 0),
              0 < t[b] && (p = a.axisY.convertValueToPixel(t[b]), D = 'undefined' !== typeof f[b] ? f[b] : q, f[b] = p);
               else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = u[k].y + (B[b] ? B[b] : 0),
    ...
    m.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          m = this.data[h],
          u = m.dataPoints;
          if (0 < u.length) for (var r = 5 < g && m.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++) if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && 'number' === typeof u[k].y) {
            n = a.axisX.convertValueToPixel(b);
            ...
            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
              ...
              D = f[b] ? f[b] : q;
              f[b] = p
            } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = p + ('undefined' !== typeof B[b] ? B[b] : 0),
            D = a.axisY.convertValueToPixel(B[b]),
            p = l[b] ? l[b] : q,
            l[b] = D;
              ...
              f[b] = A + (D - p)
            } else A = 'undefined' !== typeof l[b] ? l[b] : 0,
            D = p + A,
            p = q + A,
            a.dataSeriesIndexes.length - 1 === s && 1 >= Math.abs(e.y2 - D) && (D = e.y2),
            l[b] = A + (D - p);
            b = u[k].color ? u[k].color : m._colorSet[k % m._colorSet.length];
            V(c, y, a.axisY.reversed ? D : p, C, a.axisY.reversed ? p : D, b, 0, null, r && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y), (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) && r, !1, !1, m.fillOpacity);
            b = m.dataPointIds[k];
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < s.length) {
            ...
            c.strokeStyle = '#4572A7 ';
            for (f = 0; f < s.length; f++) if (s[f].getTime ? B = s[f].x.getTime() : B = s[f].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && 'number' === typeof s[f].y) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < u.length) {
            var r = 5 < g && m.bevelEnabled ? !0 : !1;
            c.strokeStyle = '#4572A7 ';
            for (k = 0; k < u.length; k++) if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && 'number' ===
            typeof u[k].y) {
              ...
              D;
              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[b] = u[k].y + (t[b] ? t[b] : 0),
              0 < t[b] && (D = f[b] ? f[b] : q, f[b] = n = a.axisY.convertValueToPixel(t[b]));
               else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = u[k].y + (B[b] ? B[b] : 0),
              n = l[b] ? l[b] : q,
        ...
        for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++) if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && 'number' === typeof u[k].y) {
              ...
              } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = y + (B[b] ? B[b] : 0),
              n = l[b] ? l[b] : q,
              l[b] = y = a.axisY.convertValueToPixel(B[b]);
              ...
              y = n - A,
              n = q - A,
              a.dataSeriesIndexes.length - 1 === s && 1 >= Math.abs(e.x1 - y) && (y = e.x1),
              l[b] = A + (n - y);
              b = u[k].color ? u[k].color : m._colorSet[k % m._colorSet.length];
    ...
    m.prototype.renderArea = function (a) {
      ...
      c;
      function b() {
        D && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = y : 0 > a.axisY.viewportMaximum ? C = t.y1 : 0 < a.axisY.viewportMinimum && (C = y), f.lineTo(m, C), f.lineTo(D.x, C), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (l.lineTo(m, C), l.lineTo(D.x, C), l.closePath(), l.fill()), f.beginPath(), f.moveTo(m, u), l.beginPath(), l.moveTo(m, u), D = {
          x: m,
          y: u
        })
      }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          u,
          r,
          y = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
          ...
          if (0 < s.length) {
            ...
            for (var ja = !0; h < s.length; h++) if (r = s[h].x.getTime ? s[h].x.getTime() : s[h].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja))) if ('number' !==
            typeof s[h].y) g.connectNullData || (ja || d) || b(),
            ja = !0;
             else {
              m = a.axisX.convertValueToPixel(r);
              u = a.axisY.convertValueToPixel(s[h].y);
              d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = u, m = n.x, u = n.y, b(), f.moveTo(n.x, n.y), m = d, u = c, D = n, c = g.nullDataLineDashType, f.setLineDash(R)), f.lineTo(m, u), w && l.lineTo(m, u)) : (f.beginPath(), f.moveTo(m, u), w && (l.beginPath(), l.moveTo(m, u)), D = {
                x: m,
                y: u
              }), ja = d = !1) : (f.lineTo(m, u), w && l.lineTo(m, u), 0 == h % 250 && b());
              n = {
                x: m,
                y: u
              };
              ...
              0 !== s[h].markerSize && (0 < s[h].markerSize || 0 < g.markerSize) && (r = g.getMarkerProperties(h, m, u, f), B.push(r), Y = Q(Y), w && B.push({
                x: m,
                y: u,
                ctx: l,
                type: r.type,
      ...
      function d() {
        ...
        if (0 < c.length) {
          ...
          n.lineThickness) {
            ...
            for (var d = 0; d < c.length - 3; d += 3) if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), w && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle || c[d + 3].newLineDashArray) b.strokeStyle = "green",
            b.beginPath(),
          ...
          for (d = 0; d < c.length - 3; d += 3) b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < s.length) {
            ...
            for (; h < s.length; h++) if (r = s[h].x.getTime ? s[h].x.getTime() : s[h].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
              var Y = u;
              'number' !==
              typeof s[h].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(r), u = a.axisY.convertValueToPixel(s[h].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || R === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = u, m = n.x, u = n.y, b(), f.moveTo(n.x, n.y), m = d, u = c, D = n, R = g.nullDataLineDashType, f.setLineDash(aa)), f.lineTo(m, Y), f.lineTo(m, u), w && (l.lineTo(m, Y), l.lineTo(m, u))) : (f.beginPath(), f.moveTo(m, u), w && (l.beginPath(), l.moveTo(m, u)), D = {
                x: m,
                y: u
              }), c = d = !1) : (f.lineTo(m, Y), w && l.lineTo(m, Y), f.lineTo(m, u), w && l.lineTo(m, u), 0 == h % 250 && b()), n = {
                x: m,
                y: u
              }, h < s.length - 1 && (x !== (s[h].lineColor || v) || R !== (s[h].lineDashType || g.lineDashType)) && (b(), x = s[h].lineColor || v, f.strokeStyle = x, f.setLineDash && (s[h].lineDashType ? (R = s[h].lineDashType, f.setLineDash(N(R, g.lineThickness))) : (R = g.lineDashType, f.setLineDash(F)))), r = g.dataPointIds[h], this._eventManager.objectMap[r] = {
                id: r,
                objectType: 'dataPoint',
                dataSeriesIndex: q,
                dataPointIndex: h,
                x1: m,
                y1: u
              }, 0 !== s[h].markerSize && (0 < s[h].markerSize || 0 < g.markerSize) && (Y = g.getMarkerProperties(h, m, u, f), B.push(Y), r = Q(r), w && B.push({
                x: m,
                y: u,
                ctx: l,
                type: Y.type,
    ...
    m.prototype.renderStackedArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        g,
        s,
        m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum :
        0),
        ...
        for (var e = [
        ], C = 0; C < a.dataSeriesIndexes.length; C++) {
          var D = a.dataSeriesIndexes[C],
          A = this.data[D],
          v = A.dataPoints;
          A.dataPointIndexes = [
          ];
          for (q = 0; q < v.length; q++) D = v[q].x.getTime ? v[q].x.getTime() : v[q].x,
        ...
        for (C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          if (0 < n.length) {
            ...
            for (var Y = !0, q = 0; q < n.length; q++) {
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !Y))) if ('number' !== typeof fa.y) A.connectNullData || (Y || z) || d(),
              Y = !0;
               else {
                ...
                } else s = a.axisY.convertValueToPixel(fa.y),
                s -= la;
                k.push({
                  x: g,
                  y: m - la
                ...
                h[f] = m - s;
                z || Y ? (!z && A.connectNullData ? (b.setLineDash && (A.options.nullDataLineDashType || y === A.lineDashType && A.lineDashType !== A.nullDataLineDashType) && (z = k.pop(), y = k[k.length - 1], d(), b.moveTo(u.x, u.y), k.push(y), k.push(z), y = A.nullDataLineDashType, b.setLineDash(aa)), b.lineTo(g, s), w && r.lineTo(g, s)) : (b.beginPath(), b.moveTo(g, s), w && (r.beginPath(), r.moveTo(g, s))), Y = z = !1) : (b.lineTo(g, s), w && r.lineTo(g, s), 0 == q % 250 && (d(), b.moveTo(g, s), w && r.moveTo(g, s), k.push({
                  x: g,
                  y: m - la
                })));
                u = {
                ...
                q < v.length - 1 && (R !== (v[q].lineColor || x) || y !== (v[q].lineDashType || A.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, s), k.push({
                  x: g,
                  y: m - la
                }), R = v[q].lineColor || x, b.strokeStyle = R, b.setLineDash && (v[q].lineDashType ? (y = v[q].lineDashType, b.setLineDash(N(y, A.lineThickness))) : (y = A.lineDashType, b.setLineDash(F))));
                ...
                0 <= A.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < A.markerSize) && (la = A.getMarkerProperties(A.dataPointIndexes[f], g, s, b), l.push(la), f = Q(E), w && l.push({
                  x: g,
                  y: s,
                  ctx: r,
                  type: la.type,
    ...
    m.prototype.renderStackedArea100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          if (0 < n.length) {
            ...
            for (var Y = !0, q = 0; q < n.length; q++) {
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !Y))) if ('number' !== typeof fa.y) A.connectNullData || (Y || r) || d(),
              Y = !0;
               else {
                var la;
                ...
                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                  ...
                  if (0 >= p[f] && a.axisY.logarithmic) continue;
                  s = a.axisY.convertValueToPixel(p[f])
                } else s = a.axisY.convertValueToPixel(la),
                s -= E;
                k.push({
                  x: g,
                  y: z - E
                ...
                h[f] = z - s;
                r || Y ? (!r && A.connectNullData ? (b.setLineDash && (A.options.nullDataLineDashType || u === A.lineDashType && A.lineDashType !== A.nullDataLineDashType) && (r = k.pop(), u = k[k.length - 1], d(), b.moveTo(m.x, m.y), k.push(u), k.push(r), u = A.nullDataLineDashType, b.setLineDash(aa)), b.lineTo(g, s), w && y.lineTo(g, s)) : (b.beginPath(), b.moveTo(g, s), w && (y.beginPath(), y.moveTo(g, s))), Y = r = !1) : (b.lineTo(g, s), w && y.lineTo(g, s), 0 == q % 250 && (d(), b.moveTo(g, s), w && y.moveTo(g, s), k.push({
                  x: g,
                  y: z - E
                })));
                m = {
                ...
                q < v.length - 1 && (R !== (v[q].lineColor || x) || u !== (v[q].lineDashType || A.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, s), k.push({
                  x: g,
                  y: z - E
                }), R = v[q].lineColor || x, b.strokeStyle = R, b.setLineDash && (v[q].lineDashType ? (u = v[q].lineDashType, b.setLineDash(N(u, A.lineThickness))) : (u = A.lineDashType, b.setLineDash(F))));
                if (0 <= A.dataPointIndexes[f]) {
                ...
                0 <= A.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < A.markerSize) && (E = A.getMarkerProperties(q, g, s, b), t.push(E), f = Q(G), w && t.push({
                  x: g,
                  y: s,
                  ctx: y,
                  type: E.type,
        ...
        $.drawMarkers(t);
        w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = 'source-atop', a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(l.x1, l.y1, l.width, l.height), y.restore());
        b.restore();
        return {
          source: c,
          dest: this.plotArea.ctx,
    ...
    m.prototype.renderBubble = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var t = - Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++) for (var n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, g = 0, e = 0; e < q.length; e++) f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x,
        f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || 'undefined' === typeof q[e].z || (g = q[e].z, g > t && (t = g), g < h && (h = g));
          ...
          if (0 < n.length) {
            ...
            for (var p = 0, q = 0, e = 0; e < n.length; e++) if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && 'number' === typeof n[e].y) {
              ...
              Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = k.dataPointIds[e], this._eventManager.objectMap[p] = {
                ...
                x1: f,
                y1: l
              }, p = Q(p), w && $.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness), (n[e].indexLabel || k.indexLabel || n[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                chartType: 'scatter',
                dataPoint: n[e],
                dataSeries: k,
                point: {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < z.length) for (var y = 5 < s && u.bevelEnabled ? !0 : !1, t = 0; t < z.length; t++) if (z[t].getTime ? g = z[t].x.getTime() : g = z[t].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(z[t].y) && z[t].y.length && 'number' === typeof z[t].y[0] && 'number' === typeof z[t].y[1] && 'number' === typeof z[t].y[2] && 'number' === typeof z[t].y[3]) {
            ...
            x, Math.max(k, q)), c.lineTo(h - x, p), c.stroke(), V(c, C, Math.min(k, q), v, Math.max(k, q), z[t].y[0] <= z[t].y[3] ? u.risingColor : f, A, e, y, y, !1, !1, u.fillOpacity), w && (e = Q(F), b.strokeStyle = e, b.moveTo(h - x, n), b.lineTo(h - x, Math.min(k, q)), b.stroke(), b.moveTo(h - x, Math.max(k, q)), b.lineTo(h - x, p), b.stroke(), V(b, C, Math.min(k, q), v, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : 'ohlc' === u.type && (c.moveTo(h - x, n), c.lineTo(h - x, p), c.stroke(), c.beginPath(), c.moveTo(h, k), c.lineTo(C, k), c.stroke(), c.beginPath(), c.moveTo(h, q), c.lineTo(v, q), c.stroke(), w && (e = Q(F), b.strokeStyle = e, b.moveTo(h - x, n), b.lineTo(h - x, p), b.stroke(), b.beginPath(), b.moveTo(h, k), b.lineTo(C, k), b.stroke(), b.beginPath(), b.moveTo(h, q), b.lineTo(v, q), b.stroke()));
            (z[t].indexLabel || u.indexLabel || z[t].indexLabelFormatter || u.indexLabelFormatter) && this._indexLabels.push({
              chartType: u.type,
              dataPoint: z[t],
              dataSeries: u,
              point: {
    ...
    m.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = !1, m = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
          ...
          z = this.data[u],
          y = z.dataPoints;
          if (0 < y.length) for (var C = 5 < s && z.bevelEnabled ? !0 : !1, l = 0; l < y.length; l++) if (y[l].getTime ? g = y[l].x.getTime() : g = y[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(y[l].y) && y[l].y.length && 'number' === typeof y[l].y[0] && 'number' === typeof y[l].y[1] && 'number' === typeof y[l].y[2] && 'number' === typeof y[l].y[3] && 'number' ===
          typeof y[l].y[4] && 5 === y[l].y.length) {
            ...
            (y[l].indexLabel || z.indexLabel || y[l].indexLabelFormatter || z.indexLabelFormatter) && this._indexLabels.push({
              chartType: z.type,
              dataPoint: y[l],
              dataSeries: z,
              point: {
    ...
    m.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          q = this.data[p],
          g = q.dataPoints;
          if (0 < g.length) for (var s = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++) if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !r(g[f].y) && g[f].y.length && 'number' === typeof g[f].y[0] && 'number' === typeof g[f].y[1]) {
    ...
    m.prototype.renderError = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        a.dataSeriesIndexes.length; z++) {
          ...
          F = 0;
          if (A) for (e = C._linkedSeries.id, u = 0; u < e; u++) !this.data[u].type.match(/(bar|column)/gi) || !this.data[u].visible || this.data[u].type.match(/(stacked)/gi) && F || (this.data[u].type.match(/(range)/gi) && (f = !0), F++);
          ...
          u < e && (u = e);
          u > t && (u = t);
          if (0 < D.length) for (var E = C._colorSet, t = 0; t < D.length; t++) {
            ...
            if (!(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax) && !r(D[t].y) && D[t].y.length && 'number' === typeof D[t].y[0] && 'number' === typeof D[t].y[1]) {
              ...
              if (D[t].indexLabel || C.indexLabel || D[t].indexLabelFormatter || C.indexLabelFormatter) this._indexLabels.push({
                ...
                indexKeyword: 0,
                point: {
                  x: b ? D[t].y[1] >= D[t].y[0] ? n : p : n + (p - n) / 2,
              ...
              this._indexLabels.push({
                ...
                indexKeyword: 1,
                point: {
                  x: b ? D[t].y[1] >= D[t].y[0] ? p : n : n + (p - n) / 2,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < s.length) {
            ...
            c.strokeStyle = '#4572A7 ';
            for (f = 0; f < s.length; f++) if (s[f].getTime ? k = s[f].x.getTime() : k = s[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(s[f].y) && s[f].y.length && 'number' === typeof s[f].y[0] && 'number' === typeof s[f].y[1]) {
    ...
    m.prototype.renderRangeArea = function (a) {
      function d() {
        if (z) {
          for (var a = null, c = h.length - 1; 0 <= c; c--) a = h[c],
          b.lineTo(a.x, a.y2),
          e.lineTo(a.x, a.y2);
          b.closePath();
          b.globalAlpha = n.fillOpacity;
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < p.length) {
            ...
            for (var R = !0; g < p.length; g++) if (u = p[g].x.getTime ?
            p[g].x.getTime() : p[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !R))) if (null !== p[g].y && p[g].y.length && 'number' === typeof p[g].y[0] && 'number' === typeof p[g].y[1]) {
              ...
              q || R ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || A === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = F, A = n.nullDataLineDashType, b.setLineDash(x)), b.lineTo(s, m), w && e.lineTo(s, m), h.push({
                x: s,
                y1: m,
                y2: r
              })) : (b.beginPath(), b.moveTo(s, m), z = {
                x: s,
                y: m
              }, h = [
              ], h.push({
                ...
                y1: m,
                y2: r
              }), w && (e.beginPath(), e.moveTo(s, m))), R = q = !1) : (b.lineTo(s, m), h.push({
                x: s,
                y1: m,
                y2: r
              }), w && e.lineTo(s, m), 0 == g % 250 && d());
              u = n.dataPointIds[g];
              this._eventManager.objectMap[u] = {
                id: u,
                objectType: 'dataPoint',
...
// area:
          ...
          for (f = 0; f < d.length - 3; f += 3) b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y),
          w && e.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y);
          d = v(x, 2);
          b.lineTo(x[x.length - 1].x, x[x.length - 1].y);
          for (f = d.length - 1; 2 < f; f -= 3) b.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y),
          w && e.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y);
          b.closePath();
...
/*
            ...
            for (var g = f = 0; f < d.length - 3; f += 3, g++) {
              if (r[g].newStrokeStyle || r[g].newLineDashArray) b.stroke(),
              b.beginPath(),
              b.moveTo(d[f].x, d[f].y),
...
//if (!r[g].newStrokeStyle && !r[g].newLineDashArray) continue;
...
var gradient = b.createLinearGradient(d[f].x, d[f].y, d[f+3].x, d[f+3].y);
    gradient.addColorStop(0, "#" + (Math.pow(d[f].y,11) & 0x00FFFFFF).toString(16).padStart(6, '0'));
    gradient.addColorStop(1, "#" + (Math.pow(d[f+3].y,11) & 0x00FFFFFF).toString(16).padStart(6, '0'));
    b.strokeStyle = gradient;
...
//9 vs 11
              b.beginPath(),
              b.moveTo(d[f].x, d[f].y+7),
              
  b.bezierCurveTo(d[f + 1].x, d[f + 1].y+7, d[f + 2].x, d[f + 2].y+7, d[f + 3].x, d[f + 3].y+7)

gradient = b.createLinearGradient(d[f].x, d[f].y+7, d[f+3].x, d[f+3].y+7);
    gradient.addColorStop(0, "#" + (Math.pow(d[f].y,9) & 0x00FFFFFF).toString(16).padStart(6, '0'));
    gradient.addColorStop(1, "#" + (Math.pow(d[f+3].y,9) & 0x00FFFFFF).toString(16).padStart(6, '0'));
    b.strokeStyle = gradient;
...
var gradient = b.createLinearGradient(d[f].x, d[f].y, d[f+3].x, d[f+3].y);
    gradient.addColorStop(0, "#" + (Math.pow(d[f].y,3) & 0x00FFFFFF).toString(16).padStart(6, '0'));
    gradient.addColorStop(1, "#" + (Math.pow(d[f+3].y,3) & 0x00FFFFFF).toString(16).padStart(6, '0'));
    b.strokeStyle = gradient;
...
// 9 Vs 11  
 ...
 gradient = b.createLinearGradient(d[f].x, d[f].y+7, d[f+3].x, d[f+3].y+7);
    gradient.addColorStop(0, "#" + (Math.pow(d[f].y,2) & 0x00FFFFFF).toString(16).padStart(6, '0'));
    gradient.addColorStop(1, "#" + (Math.pow(d[f+3].y,2) & 0x00FFFFFF).toString(16).padStart(6, '0'));
    b.strokeStyle = gradient;
...
b.stroke();
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < n.length) {
            ...
            typeof n[p].y[1]) {
              ...
              p < n.length - 1 && (y !== (n[p].lineColor || z) || C !== (n[p].lineDashType || k.lineDashType)) && (y = n[p].lineColor || z, r[r.length - 1].newStrokeStyle = y, b.setLineDash && (n[p].lineDashType ? (C = n[p].lineDashType, r[r.length - 1].newLineDashArray = N(C, k.lineThickness)) : (C = k.lineDashType, r[r.length - 1].newLineDashArray = D)));
            ...
            1].newLineDashArray = A, C = k.nullDataLineDashType) : (d(D, z), r = [
            ], x = [
            ])),
            g = !0;
            d(D, z);
    ...
    m.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < v.length) for (var y = 5 < q && r.bevelEnabled ? !0 : !1, C = !1, D = null, A = null, l = 0; l < v.length; l++) if (v[l].getTime ? n = v[l].x.getTime() : n = v[l].x, 'number' !== typeof v[l].y) {
            ...
            (v[l].indexLabel || r.indexLabel || v[l].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
              chartType: 'waterfall',
              dataPoint: v[l],
              dataSeries: r,
              point: {
    ...
    var W = function (a, d, c, b, e, f, l, h, m) {
      if (!(0 > c)) {
        ...
        if (!w) {
          ...
          Number((f % (2 * Math.PI)).toFixed(8)) === k && (l -= 0.0001)
        }
        a.save();
        a.globalAlpha = h;
    ...
    m.prototype.renderPie = function (a) {
      function d() {
        if (k && n) {
          ...
          l = f = 0;
          p = !1;
          for (e = 0; e < n.length; e++) h = g[(c + e) % n.length],
          1 < a && (h.midAngle > Math.PI / 2 - u && h.midAngle < Math.PI / 2 + u) && (f <= a / 2 && !p ? (h.hemisphere = 'right', f++) : (h.hemisphere = 'left', p = !0));
          p = !1;
          for (e = 0; e < n.length; e++) h = g[(d + e) % n.length],
          1 < b && (h.midAngle > 3 * Math.PI / 2 - u && h.midAngle < 3 * Math.PI / 2 + u) && (l <= b / 2 && !p ? (h.hemisphere = 'left', l++) : (h.hemisphere = 'right', p = !0))
        }
      }
      function c(a) {
        ...
        for (b = 0; b < n.length; b++) {
          ...
          if (d > c) {
            ...
            l = !1;
            if (n[b].exploded) {
              if (1e-9 < Math.abs(g[b].center.x - (y.x + e)) || 1e-9 < Math.abs(g[b].center.y - (y.y + f))) g[b].center.x = y.x + e * a,
              g[b].center.y = y.y + f * a,
              l = !0
            } else if (0 < Math.abs(g[b].center.x - y.x) || 0 < Math.abs(g[b].center.y - y.y)) g[b].center.x = y.x + e * (1 - a),
            g[b].center.y = y.y + f * (1 - a),
            l = !0;
            l && (e = {
            }, e.dataSeries = k, e.dataPoint = k.dataPoints[b], e.index = b, m.toolTip.highlightObjects([e]));
        ...
        a.lineJoin = 'round';
        for (b = b = 0; b < n.length; b++) c = g[b],
        c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = 'left' === c.hemisphere ? 'inside' !==
      ...
      function l() {
        ...
        for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
          ...
          } else for (a = 0; a < n.length; a++) h = g[a],
          w = 'pie' === k.type ? 0.7 * A : 0.8 * A,
          u = y.x + w * Math.cos(h.midAngle),
          r = y.y + w * Math.sin(h.midAngle),
          h.indexLabelTextBlock.x = u,
          h.indexLabelTextBlock.y = r;
          for (a = 0; a < n.length; a++) if (h = g[a], u = h.indexLabelTextBlock.measureText(), 0 !== u.height && 0 !== u.width) u = u = 0,
          'right' === h.hemisphere ? (u = q.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width +
          p), u *= - 1) : u = q.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - p),
          0 < u && (!l && h.indexLabelText && (r = 'right' === h.hemisphere ? q.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - q.x1, 0.3 * h.indexLabelTextBlock.maxWidth > r ? h.indexLabelText = '' : h.indexLabelTextBlock.maxWidth = 0.85 * r, 0.3 * h.indexLabelTextBlock.maxWidth < r && (h.indexLabelTextBlock.x -= 'right' === h.hemisphere ? 2 : - 2)), Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - y.y) < A || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - y.y) < A) && (u /= Math.abs(Math.cos(h.indexLabelAngle)), 9 < u && (u *= 0.3), u > d && (d = u)),
          u = u = 0,
          0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? (u = q.y2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + 5), u *= - 1) : u = q.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5),
          0 < u && (!l && h.indexLabelText && (r = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? - 1 : 1, 0 === f(a, u * r) && f(a, 2 * r)), Math.abs(h.indexLabelTextBlock.x - y.x) < A && (u /= Math.abs(Math.sin(h.indexLabelAngle)), 9 < u && (u *= 0.3), u > d && (d = u)));
          var H = function (a, b, c) {
            for (var d = [
            ], e = 0; d.push(g[b]), b !== c; b = (b + 1 + n.length) % n.length);
            d.sort(function (a, b) {
              return a.y - b.y
            });
            for (b = 0; b < d.length; b++) if (c = d[b], e < 0.7 * a) e += c.indexLabelTextBlock.height,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        C = 0;
        a = !1;
        for (var D = 0; D < n.length; D++) C += Math.abs(n[D].y),
    ...
    m.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        if (0 ===
        g) return - 1;
        for (var l = d[0] = 0, h = 0, n, p, b = b - a, l = !1, k = 0; k < z.length; k++) a = Math.abs(z[k].y) * f / g,
        l ? n = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = V * V * b * b - 4 * Math.abs(V) * a, 0 > p ? (p = c, l = (b + p) * (e - h) / 2, a -= l, n = e - h, h += e - h, n += 0 == p ? 0 : a / p, h += a / p, l = !0) : (n = (Math.abs(V) * b - Math.sqrt(p)) / 2, p = b - 2 * n / Math.abs(V), h += n, h > e && (h -= n, p = c, l = (b + p) * (e - h) / 2, a -= l, n = e - h, h += e - h, n += a / p, h += a / p, l = !0), b = p)),
        d.push(n);
        return d
      }
      function b() {
        if (u && z) {
          for (var a, b, c, d, e, f, k, l, h, n, p, q, t, m, s, B = [
          ], y = [
          ], v = {
            percent: null,
            total: null
          }, C = null, A = 0; A < z.length; A++) s = O[A],
          s = 'undefined' !== typeof s.x5 ? (s.y2 + s.y4) / 2 : (s.y2 + s.y3) / 2,
          s = g(s).x2 + 1,
          B[A] = M - s - X;
          s = 0.5 * X;
          for (var A = 0, D = z.length - 1; A < z.length || 0 <= D; A++, D--) {
            ...
            x._eventManager.objectMap[t] = {
              ...
              dataPointIndex: A,
              dataSeriesIndex: 0,
              funnelSection: O[u.reversed ? z.length - 1 - A : A]
            };
      ...
      function e() {
        ...
        if (e) for (l = I.length - 1; 0 <= l; l--) a = O[l],
        I[l].textBlock.maxWidth = f[f.length - (l + 1)],
        I[l].textBlock.measureText(),
        I[l].textBlock.x = M - k,
        c = I[l].textBlock.height < I[l].textBlock.maxHeight ? I[l].textBlock.height :
        ...
        u.reversed ? (I[l].textBlock.y + I[l].height > ma + C && (I[l].textBlock.y = ma + C - I[l].height), I[l].textBlock.y < ra - C && (I[l].textBlock.y = ra - C)) : (I[l].textBlock.y < ma - C && (I[l].textBlock.y = ma - C), I[l].textBlock.y + I[l].height > ra + C && (I[l].textBlock.y = ra + C - I[l].height))
      }
      function f() {
        var a,
        b,
        ...
        if ('inside' !== u.indexLabelPlacement) for (var e = 0; e < O.length; e++) 0 == I[e].textBlock.text.length ? I[e].isDirty = !0 : (a = O[e], c = 'undefined' !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = u.reversed ? 'undefined' !== typeof a.x5 ? c > wa ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : 'undefined' !== typeof a.x5 ? c < wa ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, I[e].textBlock.x = b + X, I[e].textBlock.y = c - I[e].height / 2, u.reversed ? (I[e].textBlock.y + I[e].height > ma + C && (I[e].textBlock.y = ma + C - I[e].height), I[e].textBlock.y < ra - C && (I[e].textBlock.y = ra - C)) : (I[e].textBlock.y < ma - C && (I[e].textBlock.y = ma - C), I[e].textBlock.y + I[e].height > ra + C && (I[e].textBlock.y = ra + C - I[e].height)));
         else for (e = 0; e < O.length; e++) 0 == I[e].textBlock.text.length ? I[e].isDirty = !0 : (a = O[e], b = a.height, c = I[e].height, d = I[e].width, b >= c ? (b = e != ca ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2, c = e != ca ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, I[e].textBlock.x = b, I[e].textBlock.y = c) : I[e].isDirty = !0)
      }
      function l() {
        function a(b, c) {
          var d;
          ...
          if (d >= c) return f.y += c,
          c;
          if (b == O.length - 1) return 0 < d && (f.y += d),
          d;
          d += a(e, c - d);
          0 < d && (f.y += d);
          return d
        ...
        function c(a, b, d) {
          ...
          for (d = 0; d < e.length; d++) if (b = e[d], f < a) g++,
          f += I[b.id].height + da,
        ...
        for (var d, e, f, g, k, l, n = 1, m = 0; m < 2 * n; m++) {
          for (var s = I.length - 1; 0 <= s && !(0 <= p(s) && p(s), f = I[s], g = f.textBlock, l = (k = q(s) < O.length ? I[q(s)] : null) ? k.textBlock : null, d = + f.height.toFixed(6), e = + g.y.toFixed(6), !f.isDirty && (k && e + d + da > + l.y.toFixed(6)) && (d = g.y + d + da - l.y, e = a(s, - d), e < d && (0 < e && (d -= e), e = a(q(s), d), e != d))); s--);
          b()
        }
      }
      function h(a, b) {
      ...
      function m(a, b, c) {
        ...
        g = function () {
          for (var a = [
          ], b = 0; b < O.length; b++) a.push(l[b] - O[b].y1);
          return a
        }();
        var q = {
          ...
          changeSection: function (a) {
            for (var b, c, d = 0; d < O.length; d++) b = g[d],
            c = O[d],
            b *= a,
      ...
      function n(a) {
        for (var b, c, d, e, f = 0; f < O.length; f++) e = 1 === I[f].lineThickness % 2 ? 0.5 : 0,
        c = ((O[f].y2 + O[f].y4) / 2 << 0) + e,
        b = g(c).x2 - 1,
        d = I[f].textBlock.x,
        e = (I[f].textBlock.y + I[f].height / 2 << 0) + e,
        I[f].isDirty || 0 == I[f].lineThickness || (a.strokeStyle = I[f].lineColor, a.lineWidth = I[f].lineThickness, a.setLineDash && a.setLineDash(N(I[f].lineDashType, I[f].lineThickness)), a.beginPath(), a.moveTo(b, c), a.lineTo(d, e), a.stroke())
      }
      function p(a) {
      ...
      function g(a) {
        for (var b, c = 0; c < z.length; c++) if (O[c].y1 < a && O[c].y4 > a) {
          b = O[c];
          break
        }
      ...
      function v(a) {
        ...
        if (x.subtitles) for (var b = 0; b < x.subtitles.length; b++) {
          var c = x.subtitles[b];
          if (c.dockInsidePlotArea || 'center' === c.horizontalAlign && 'center' === c.verticalAlign) x.subtitles.ctx = a,
          c.render()
        }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 != u.length && (u.dataPoints && u.visible) && 0 !== z.length) {
          ...
          if ( - 1 !== H) {
            ...
            1; 0 < G; G--) Z += H[G],
            E.push(Z);
             else for (G = 0; G < H.length; G++) Z += H[G],
            E.push(Z);
            ...
            for (G = 0; G < H.length - 1; G++) Z = u.reversed ? z[z.length - 1 - G].color ? z[z.length - 1 - G].color : u._colorSet[(z.length - 1 - G) % u._colorSet.length] : z[G].color ? z[G].color : u._colorSet[G % u._colorSet.length],
            G ===
            ca ? O.push({
              x1: a[G],
              y1: E[G],
            ...
            for (G = 0; G < O.length; G++) A = O[G],
            oa(T, A, u.fillOpacity),
            ga.push(A.y1);
            v(T);
            J && u.visible && ('inside' === u.indexLabelPlacement || x.animationEnabled || n(T), x.animationEnabled || s());
            if (!J) for (G = 0; G < z.length; G++) A = u.dataPointIds[G],
            a = {
              id: A,
              objectType: 'dataPoint',
              dataPointIndex: G,
              dataSeriesIndex: 0,
              funnelSection: O[u.reversed ? z.length - 1 - G : G]
            },
    ...
    m.prototype.getPercentAndTotal = function (a, d) {
      ...
      b = null,
      e = c = null;
      if (0 <= a.type.indexOf('stacked')) b = 0,
    ...
    E.prototype.setLayout = function () {
      ...
      this.items = m;
      for (n = 0; n < this.items.length; n++) q = m[n],
    ...
    E.prototype.render = function () {
      ...
      for (var h = 0, m = 0; m < l.length; m++) {
        ...
        k.items.length; p++) {
          ...
          this.ctx.clip();
          if ('line' === q.chartType || 'stepLine' === q.chartType || 'spline' === q.chartType) this.ctx.strokeStyle = q.lineColor,
    ...
    H.prototype.getDataPointAtXY = function (a, d, c) {
      ...
      p = 1 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * Math.log(p / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;
       else q = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x,
      p = 0 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * (p - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;
      for (; ; ) {
        f = 0 < l ? p + e : p - e;
        if (0 <= f && f < this.dataPoints.length) {
          ...
          if (q) {
            switch (this.type) {
              ...
              case 'pyramid':
                s = q.funnelSection;
                d > s.y1 && d < s.y4 && (s.y6 ? d > s.y6 ? (f = s.x6 + (s.x5 - s.x6) / (s.y5 - s.y6) * (d - s.y6), s = s.x3 + (s.x4 - s.x3) / (s.y4 - s.y3) * (d - s.y3)) : (f = s.x1 + (s.x6 - s.x1) / (s.y6 - s.y1) * (d - s.y1), s = s.x2 + (s.x3 - s.x2) / (s.y3 - s.y2) * (d - s.y2)) : (f = s.x1 + (s.x4 - s.x1) / (s.y4 - s.y1) * (d - s.y1), s = s.x2 + (s.x3 - s.x2) / (s.y3 - s.y2) * (d - s.y2)), a > f && a < s && (b.push({
                  dataPoint: g,
                  dataPointIndex: q.dataPointIndex,
                  dataSeries: this,
                  distance: 0
    ...
    F.prototype.createExtraLabelsForLog = function (a) {
      ...
      if (!(5 < a)) {
        ...
        this.noTicks - 1) {
          for (var c = F.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), b = Math.ceil(this.viewportMinimum / c) * c; b < d; b += c) b < this.viewportMinimum || this.logLabelValues.push(b);
    ...
    F.prototype.createLabels = function () {
      ...
      if ('axisX' !== this.type || 'dateTime' !== this.valueType || this.logarithmic) {
        ...
        if (this.labels) {
          a = Math.ceil(b);
          for (var b = Math.ceil(this.intervalStartPosition), g = !1, c = b; c < this.viewportMaximum; c += a) if (this.labels[c]) g = !0;
           else {
            g = !1;
            break
          }
        ...
        ], this.createExtraLabelsForLog()), b = 0, g = q; b < this.logLabelValues.length; b++) if (c = this.logLabelValues[b], c < this.viewportMinimum) b++;
         else {
      ...
      } else for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = Xa(new Date(this.viewportMaximum), this.interval, this.intervalType), g = q, c = this.intervalStartPosition; c < e; Xa(c, b, this.intervalType)) {
      ...
      Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * T[this.intervalType + 'Duration'] * this.interval,
      ...
      this.chart.panEnabled || (l = 'undefined' === typeof this.options.labelWrap || this.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize);
       else if ('left' === this._position || 'right' === this._position) h = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * T[this.intervalType + 'Duration'] * this.interval,
      ...
      q = p = 0;
      if (this.labelAutoFit || this.options.labelAutoFit) if (r(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), 'bottom' === this._position || 'top' === this._position) if (f = 0.9 * h >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
        ...
        for (c = 0; c < this._labels.length; c++) if (!this._labels[c].breaksLabelType) {
          ...
          for (var v, g = a.text.split(' '), b = 0; b < g.length; b++) n = g[b],
          this.ctx.font = a.fontStyle + ' ' +
          a.fontWeight + ' ' + a.fontSize + 'px ' + a.fontFamily,
        ...
        for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++) if (!this._labels[c].breaksLabelType) {
          ...
          if (r(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle) if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), n = (k - (m + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs( - 25))) / Math.sin(Math.PI / 180 * Math.abs( - 25)), !r(this.options.labelWrap)) this.labelWrap ? r(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), n), this.sessionVariables.labelWrap = this.labelWrap, d && s.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = - 25)) : (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? - 25 : this.sessionVariables.labelAngle) : r(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelMaxWidth = f, d && s.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = - 25, this.sessionVariables.labelMaxWidth = n)) : (this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? - 25 : this.sessionVariables.labelAngle, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelWrap = this.labelWrap);
            ...
            f ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelAngle = - 25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = l);
             else if (!r(d)) if (b = s.width + d.width >> 0, g = this.labelFontSize, q < f) b - 2 * f > p && (p = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, r(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ?
            ...
            this.sessionVariables.labelMaxWidth = n;
             else if (0 === p) for (this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, b = 0; b < this._labels.length; b++) a = this._labels[b].textBlock,
            a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), n),
            s = a.measureText(),
            b < this._labels.length - 1 && (g = b + 1, d = this._labels[g].textBlock, d.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), n), d = d.measureText(), s.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = - 25))
      ...
      a.measureText();
       else if ('left' === this._position || 'right' === this._position) if (f = r(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, l = 'undefined' === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
        this.sessionVariables.labelFontSize = this.labelFontSize;
        this.sessionVariables.labelMaxWidth = f;
        this.sessionVariables.labelMaxHeight = l;
        ...
        for (c = 0; c < this._labels.length; c++) if (!this._labels[c].breaksLabelType) {
          ...
          this.labelFontSize : this.options.labelFontSize, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelAngle = r(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : h > 10 * l && h < 50 * l && (r(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelAngle = r(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))) : (this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth)) : (this.sessionVariables.labelMaxWidth = this.labelWrap ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : this.labelMaxWidth ? this.options.labelMaxWidth ?
      ...
      a.maxWidth = this.labelMaxWidth = r(this.options.labelMaxWidth) ? r(this.sessionVariables.labelMaxWidth) ? this.sessionVariables.labelMaxWidth = f : this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth,
      a.fontSize = this.labelFontSize = r(this.options.labelFontSize) ? r(this.sessionVariables.labelFontSize) ? this.sessionVariables.labelFontSize = this.labelFontSize : this.sessionVariables.labelFontSize : this.options.labelFontSize,
      a.angle = this.labelAngle = r(this.options.labelAngle) ? r(this.sessionVariables.labelAngle) ? this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle,
      a.wrap = this.labelWrap = r(this.options.labelWrap) ? r(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap,
      a.maxHeight = r(this.sessionVariables.labelMaxHeight) ?
      this.sessionVariables.labelMaxHeight = l : this.sessionVariables.labelMaxHeight,
      a.measureText();
      for (c = 0; c < this.stripLines.length; c++) {
        ...
        } else l = 'bottom' === this._position || 'top' === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0,
    ...
    F.setLayout = function (a, d, c, b, e, f) {
      ...
      for (g = 0; g < q.length; g++) if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length) for (var s = q[g].scaleBreaks._appliedBreaks, w = 0; w < s.length && !(s[w].startValue > q[g].viewportMaximum); w++) s[w].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w), s[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
      ...
      for (g = 0; g < q.length; g++) if (q[g].title) switch (q[g]._position) {
        ...
        default:
          ...
          q[g]._titleTextBlock.maxHeight = q[g].titleWrap ? 0.8 * f.height : 1.5 * q[g].titleFontSize,
      ...
      if ('normal' === e) {
        ...
        w; ) {
          ...
          O = 0,
          $ = 0;
          if (c && 0 < c.length) for (x = [
          ], g = O = 0; g < c.length; g++) x.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)),
          O += x[g],
          L += c[g] && !n.isNavigator ? c[g].margin : 0;
           else x.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
          P.push(x);
          if (b && 0 < b.length) for (D = [
          ], g = $ = 0; g < b.length; g++) D.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)),
          $ += D[g],
          Z += b[g] ? b[g].margin : 0;
          ...
          if (a && 0 < a.length) for (z = [
          ], g = U = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates = {
          }),
          ...
          0));
          M.push(z);
          if (d && 0 < d.length) for (y = [
          ], g = V = 0; g < d.length; g++) d[g] && (d[g].lineCoordinates = {
          }),
          ...
          N.push(y);
          if (a && 0 < a.length) for (g = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates.x1 = l, m = Math.round(f.x2 - $ - Z > n.width - p ? n.width - p : f.x2 - $ - Z), a[g]._labels && 1 < a[g]._labels.length && (h = k = 0, k = a[g]._labels[1], h = 'dateTime' === a[g].valueType ? a[g]._labels[a[g]._labels.length - 2] : a[g]._labels[a[g]._labels.length - 1], v = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), u = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height -
          h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle))), !a[g] || (!a[g].labelAutoFit || r(A) || r(F) || n.isNavigator || n.stockChart) || (h = 0, 0 < a[g].labelAngle ? F + u > m && (h += 0 < a[g].labelAngle ? F + u - m - $ : 0) : 0 > a[g].labelAngle ? A - v < l && A - v < a[g].viewportMinimum && (E = l - (L + a[g].tickLength + x + A - v + a[g].labelFontSize / 2)) : 0 === a[g].labelAngle && (F + u > m && (h = F + u / 2 - m - $), A - v < l && A - v < a[g].viewportMinimum && (E = l - L - a[g].tickLength - x - A + v / 2)), a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < h ? m -= h : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < E ? l += E : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < E && (l += E), 0 < h && (m -= h))), n.panEnabled ? U = r(n.sessionVariables.axisX.height) ? n.sessionVariables.axisX.height = U : n.sessionVariables.axisX.height : n.sessionVariables.axisX.height = U, h = Math.round(f.y2 - U - e + G), k = Math.round(f.y2), a[g].lineCoordinates.x2 = m, a[g].lineCoordinates.width = m - l, a[g].lineCoordinates.y1 = h, a[g].lineCoordinates.y2 = h + a[g].lineThickness / 2, 'inside' === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.y1 = a[g].lineCoordinates.y1 + z[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0) - ('inside' === a[g].tickPlacement ? a[g].tickLength : 0), a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2), a[g].bounds = {
            x1: l,
            y1: h,
            x2: m,
            y2: k - (U + e - z[g] - G),
          ...
          T += y[g] + d[g].margin;
          if (c && 0 < c.length) for (g = 0; g < c.length; g++) L = n.isNavigator ? 0 : 10,
          c[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : p, h = Math.round(f.y1 + V + W < Math.max(L, p) ? Math.max(L, p) : f.y1 + V + W), m = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : p, k = Math.round(f.y2 - U - e - L), c[g].lineCoordinates = {
            x1: l - S,
            y1: h,
            x2: m - S,
            y2: k,
          ...
          if (b && 0 < b.length) for (g = 0; g < b.length; g++) b[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), m = Math.round(l), L = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(f.y1 + V + W < Math.max(L, p) ? Math.max(L, p) : f.y1 + V + W), L = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (U + e + L)), b[g].lineCoordinates = {
            x1: l + X,
            y1: h,
            x2: l + X,
            y2: k,
          ...
          if (a && 0 < a.length) for (g = 0; g < a.length; g++) a[g] && (a[g].calculateValueToPixelConversionParameters(), a[g].calculateBreaksSizeInValues(), a[g]._labels && 1 < a[g]._labels.length && (A = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase : a[g]._labels[1].position - a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1, l = a[g]._labels[a[g]._labels.length - ('dateTime' ===
          ...
          d[g]._labels && 1 < d[g]._labels.length && (A = (d[g].logarithmic ?
          Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1, l = d[g]._labels[d[g]._labels.length - ('dateTime' === d[g].valueType ? 2 : 1)].position, l = d[g].getApparentDifference(d[g].viewportMinimum, l), F = d[g].logarithmic ? (1 < l ? Math.log(l) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1);
          ...
          if (0 < w) {
            ...
            if (b && 0 < b.length) for (g = 0; g < b.length; g++) K = Q[w -
            1][g] === Q[w][g] ? !0 : !1;
             else K = !0
          }
          if (s && H && J && K) break;
        ...
        for (N = [
          ...
          ], g = X = 0; g < a.length; g++) E.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)),
          X += E[g],
          e += a[g] && !n.isNavigator ? a[g].margin : 0;
           else E.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
          M.push(E);
          if (d && 0 < d.length) for (v = [
          ], g = U = 0; g < d.length; g++) v.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)),
          U += v[g],
          W += d[g] ? d[g].margin : 0;
          ...
          c[g].labelAutoFit && !r(z) && (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, z) : 0 === c[g].labelAngle ? Math.max(l, z / 2) : l), 0 < !d.length && (m = 0 < c[g].labelAngle ? m - y / 2 : 0 === c[g].labelAngle ? m - y / 2 : m)),
          ...
          if (c && 0 < c.length) for (p = [
          ], g = S = 0; g < c.length; g++) p.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)),
          S += p[g] + c[g].margin,
          L += c[g].margin;
           else p.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
          F.push(p);
          if (b && 0 < b.length) for (A = [
          ], g = T = 0; g < b.length; g++) A.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)),
          T += A[g],
          Z += b[g].margin;
           else A.push(Math.ceil(b[0] ?
          b[0].createLabelsAndCalculateHeight() : 0));
          u.push(A);
          if (c && 0 < c.length) for (g = 0; g < c.length; g++) 0 < c[g]._labels.length && (k = c[g]._labels[0], h = c[g]._labels[c[g]._labels.length - 1], z = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), y = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)));
          ...
          if (n.panEnabled) for (g = 0; g < c.length; g++) p[g] = r(n.sessionVariables.axisY.height) ?
          ...
          'inside' === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + p[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ('inside' ===
          c[g].tickPlacement ? c[g].tickLength : 0), c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2),
          c[g].bounds = {
            x1: l,
          ...
          V += p[g] + c[g].margin;
          if (b && 0 < b.length) for (g = b.length - 1; 0 <= g; g--) b[g] && (h = Math.round(f.y1), k = Math.round(f.y1 + (A[g] + b[g].margin + G)), b[g].lineCoordinates.y1 = k, b[g].lineCoordinates.y2 = k, 'inside' === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = k - A[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = {
            x1: l,
            y1: h + (b[g].margin + G),
            x2: m,
            y2: k,
          ...
          if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
            ...
            if (c && 0 < c.length) for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (m = 0 > c[L].labelAngle ? Math.max(m, z) : 0 === c[L].labelAngle ? Math.max(m, z / 2) : m, l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? m - X : l);
          ...
          if (d && 0 < d.length) for (g = 0; g < d.length; g++) {
            ...
            k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - S > n.height - Math.max(L, 10) ? n.height - Math.max(L, 10) : f.y2 - S) : f.y2 > n.height - Math.max(L, 10) ? n.height - Math.max(L, 10) : f.y2;
            if (c && 0 < c.length) for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (m = 0 > c[L].labelAngle ? Math.max(m, z) : 0 === c[L].labelAngle ? Math.max(m, z / 2) : m, l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? m - U : l);
          ...
          if (0 < w) {
            ...
            if (d && 0 < d.length) for (g = 0; g < d.length; g++) H = N[w - 1][g] === N[w][g] ? !0 :
            !1;
             else H = !0;
    ...
    F.render = function (a, d, c, b, e) {
      ...
      if (d && 0 < d.length) for (l = 0; l < d.length; l++) d[l].renderGrid(),
      w && (d[l].createMask(), d[l].renderBreaksBackground());
      if (c && 0 < c.length) for (l = 0; l < c.length; l++) c[l].renderGrid(),
    ...
    F.prototype.calculateBreaksSizeInValues = function () {
      ...
      ], c = this.conversionParameters.pixelPerUnit || a / (this.logarithmic ?
      this.conversionParameters.maximum / this.conversionParameters.minimum : this.conversionParameters.maximum - this.conversionParameters.minimum), b = this.scaleBreaks && !r(this.scaleBreaks.options.spacing), e, f = 0; f < d.length; f++) e = b || !r(d[f].options.spacing),
    ...
    F.prototype.calculateBreaksInPixels = function () {
      if (!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {
        ...
        for (var d = 0; d < a.length && !(a[d].startValue > this.conversionParameters.maximum); d++) a[d].endValue < this.conversionParameters.minimum || (r(this.scaleBreaks.firstBreakIndex) && (this.scaleBreaks.firstBreakIndex = d), a[d].startValue >= this.conversionParameters.minimum && (a[d].startPixel = this.convertValueToPixel(a[d].startValue), this.scaleBreaks.lastBreakIndex = d), a[d].endValue <= this.conversionParameters.maximum && (a[d].endPixel = this.convertValueToPixel(a[d].endValue)))
      }
    };
    F.prototype.renderLabelsTicksAndTitle = function () {
      ...
      if ('undefined' === typeof this.options.interval) {
        if ('bottom' === this._position || 'top' === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
          for (var c = [
          ], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, l, h = this.viewportMaximum, m = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length -
          1; 0 <= k; k--) {
            p = this._labels[k];
        ...
        if ('left' === this._position || 'right' === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
          for (var c = [
          ], n, h = this.viewportMaximum, m = this.lineCoordinates.height / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
            p = this._labels[k];
            if (p.position < this.viewportMinimum) break;
      ...
      if ('bottom' === this._position) {
        ...
        0), this.ctx.lineTo(b, q.y + this.tickLength << 0), this.ctx.stroke()), d && 0 !== f++ % 2 && this.labelAutoFit || (0 === p.textBlock.angle ? (q.x -= p.textBlock.width / 2, q.y = 'inside' === this.labelPlacement ? q.y - (('inside' === this.tickPlacement ? this.tickLength : 0) + p.textBlock.height - p.textBlock.fontSize / 2) : q.y + ('inside' === this.tickPlacement ? 0 : this.tickLength) + p.textBlock.fontSize / 2 + 5) : (q.x = 'inside' === this.labelPlacement ? 0 > this.labelAngle ? q.x : q.x - p.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : q.x - (0 > this.labelAngle ? p.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0), q.y = 'inside' === this.labelPlacement ? 0 > this.labelAngle ? q.y - ('inside' === this.tickPlacement ? this.tickLength : 0) - 5 : q.y - ('inside' === this.tickPlacement ? this.tickLength : 0) - Math.abs(p.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) + 5) : q.y + ('inside' === this.tickPlacement ? 0 : this.tickLength) + Math.abs(0 > this.labelAngle ? p.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5)), p.textBlock.x = q.x, p.textBlock.y = q.y));
        ...
        for (k = 0; k < this._labels.length; k++) p = this._labels[k],
        p.position < this.viewportMinimum || p.position > this.viewportMaximum || (q = this.getPixelCoordinatesOnAxis(p.position), this.tickThickness && 'inside' != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? (q.x << 0) + 0.5 : q.x << 0, this.ctx.beginPath(), this.ctx.moveTo(b, q.y << 0), this.ctx.lineTo(b, q.y - this.tickLength << 0), this.ctx.stroke()), d && 0 !== f++ % 2 && this.labelAutoFit || (0 === p.textBlock.angle ? (q.x -= p.textBlock.width / 2, q.y = 'inside' === this.labelPlacement ? q.y + this.labelFontSize / 2 + ('inside' === this.tickPlacement ? this.tickLength : 0) + 5 : q.y - (('inside' === this.tickPlacement ? 0 : this.tickLength) + p.textBlock.height - p.textBlock.fontSize / 2)) : (q.x = 'inside' === this.labelPlacement ? 0 <
      ...
      if ('inside' === this.labelPlacement) this.chart.addEventListener('dataAnimationEnd', function () {
        for (k = 0; k < a._labels.length; k++) p = a._labels[k],
        p.position < a.viewportMinimum || (p.position > a.viewportMaximum || d && 0 !== f++ % 2 && a.labelAutoFit) || (a.ctx.save(), a.ctx.beginPath(), p.textBlock.render(!0), a.ctx.restore())
      }, this);
       else for (k = 0; k < this._labels.length; k++) p = this._labels[k],
      p.position < this.viewportMinimum || (p.position > this.viewportMaximum || d && 0 !== f++ % 2 && this.labelAutoFit) || p.textBlock.render(!0)
    };
    ...
    F.prototype.renderStripLinesOfThicknessType = function (a) {
      if (this.stripLines && 0 < this.stripLines.length && a) {
        for (var d = this, c, b = 0, e = 0, f = !1, l = !1, h = [
        ], m = [
        ], l = !1, b = 0; b < this.stripLines.length; b++) {
        ...
        for (b = 0; b < this._stripLineLabels.length; b++) if (k = this.stripLines[b], c = this._stripLineLabels[b], !(c.position < this.viewportMinimum || c.position > this.viewportMaximum || isNaN(this.range))) {
          ...
          } else 'top' === this._position ? (n = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, this.ctx.beginPath(), this.ctx.moveTo(n, a.y << 0), this.ctx.lineTo(n, a.y - this.tickLength << 0), this.ctx.stroke(), 0 === this.labelAngle ? (a.x -= c.textBlock.width / 2, a.y -= this.tickLength + c.textBlock.height - c.textBlock.fontSize / 2) : (a.x += (c.textBlock.height - this.tickLength - this.labelFontSize / 2) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0), a.y -= this.tickLength + (c.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? c.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0)))) : 'left' === this._position ? (n = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, this.ctx.beginPath(), this.ctx.moveTo(a.x <<
        ...
        if (!l) {
          ...
          this.ctx.clip();
          for (b = 0; b < h.length; b++) k = h[b],
          k.showOnTop ? f || (f = !0, this.chart.addEventListener('dataAnimationIterationEnd', function () {
            this.ctx.save();
            this.ctx.beginPath();
            this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
            this.ctx.clip();
            for (e = 0; e < h.length; e++) k = h[e],
            k.showOnTop && k.render();
            this.ctx.restore()
          }, k)) : k.render();
          for (b = 0; b < m.length; b++) c = m[b],
          c.stripLine.showOnTop ? l || (l = !0, this.chart.addEventListener('dataAnimationIterationEnd', function () {
            for (e = 0; e < m.length; e++) c = m[e],
            'inside' === c.stripLine.labelPlacement && c.stripLine.showOnTop && (d.ctx.save(), d.ctx.beginPath(), d.ctx.rect(d.chart.plotArea.x1, d.chart.plotArea.y1, d.chart.plotArea.width, d.chart.plotArea.height), d.ctx.clip(), c.textBlock.render(!0), d.ctx.restore())
          }, c.textBlock)) : 'inside' === c.stripLine.labelPlacement && c.textBlock.render(!0);
          this.ctx.restore();
          l = !0
        }
        if (l) for (l = !1, b = 0; b < m.length; b++) c = m[b],
    ...
    F.prototype.renderAxisLine = function () {
      ...
      if ('bottom' === this._position || 'top' === this._position) {
        if (this.lineThickness) {
          ...
          d.beginPath();
          if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex)) if (r(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
           else for (var h = this.scaleBreaks.firstBreakIndex; h <= this.scaleBreaks.lastBreakIndex; h++) d.moveTo(e, l),
        ...
        d.beginPath();
        if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex)) if (r(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c;
         else for (h = this.scaleBreaks.firstBreakIndex; h <= this.scaleBreaks.lastBreakIndex; h++) d.moveTo(l, e),
    ...
    F.prototype.getPixelCoordinatesOnAxis = function (a) {
      ...
      if ('left' === this._position || 'right' === this._position) d.y = this.convertValueToPixel(a),
      ...
      if (this.logarithmic) {
        ...
        if (c <= this.conversionParameters.reference === ('left' === this._position || 'right' === this._position) !== this.reversed) for (c = 0; c < e.length; c++) {
          ...
          e[c].startValue) {
            a = Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size));
            break
          } else a *= e[c].startValue / this.conversionParameters.minimum * Math.pow(e[c].size, Math.log(e[c].startValue / this.conversionParameters.minimum) / Math.log(e[c].endValue / e[c].startValue)) * b,
        ...
        if (c <= this.conversionParameters.reference === ('left' === this._position || 'right' === this._position) !== this.reversed) for (c = 0; c < e.length; c++) {
          if (!(e[c].endValue < this.conversionParameters.minimum)) if (d) if (e[c].startValue < this.conversionParameters.minimum) {
            ...
            e[c].size * (e[c].endValue - this.conversionParameters.minimum) / (e[c].endValue - e[c].startValue),
          ...
          a = 0 >= e[c].size ? 0 : b * (e[c].endValue - e[c].startValue) / e[c].size;
          break
        } else a += e[c].startValue - this.conversionParameters.minimum + e[c].size * (this.conversionParameters.minimum - e[c].startValue) / (e[c].endValue - e[c].startValue),
    ...
    F.prototype.calculateValueToPixelConversionParameters = function (a) {
      ...
      if (this.logarithmic) for (var e = 0; e < a.length && !(this.viewportMaximum < a[e].startValue); e++) this.viewportMinimum > a[e].endValue || (this.viewportMinimum >= a[e].startValue && this.viewportMaximum <= a[e].endValue ? c = 0 : this.viewportMinimum <= a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b / a[e].endValue * a[e].startValue, c = 0 < a[e].spacing.toString().indexOf('%') ? c * (1 - parseFloat(a[e].spacing) / 100) : c - Math.min(a[e].spacing, 0.1 * c)) : this.viewportMinimum > a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b / a[e].endValue * this.viewportMinimum, c = 0 < a[e].spacing.toString().indexOf('%') ? c * (1 - parseFloat(a[e].spacing) / 100 * Math.log(a[e].endValue / this.viewportMinimum) / Math.log(a[e].endValue / a[e].startValue)) : c - Math.min(a[e].spacing, 0.1 * c) * Math.log(a[e].endValue / this.viewportMinimum) / Math.log(a[e].endValue / a[e].startValue)) : this.viewportMinimum <= a[e].startValue && this.viewportMaximum < a[e].endValue && (b = b / this.viewportMaximum * a[e].startValue, c = 0 < a[e].spacing.toString().indexOf('%') ? c * (1 - parseFloat(a[e].spacing) / 100 * Math.log(this.viewportMaximum / a[e].startValue) / Math.log(a[e].endValue / a[e].startValue)) : c - Math.min(a[e].spacing, 0.1 * c) * Math.log(this.viewportMaximum / a[e].startValue) / Math.log(a[e].endValue / a[e].startValue)));
       else for (e = 0; e < a.length && !(this.viewportMaximum <
      ...
      d.range = b;
      if ('bottom' === this._position || 'top' === this._position) this.logarithmic ? (d.lnLogarithmBase = Math.log(this.logarithmBase), d.pixelPerUnit = (this.reversed ? - 1 : 1) * c * d.lnLogarithmBase / Math.log(Math.abs(b))) : d.pixelPerUnit = (this.reversed ? - 1 : 1) * c / Math.abs(b),
      d.reference = this.reversed ? this.lineCoordinates.x2 : this.lineCoordinates.x1;
      if ('left' === this._position || 'right' === this._position) this.logarithmic ? (d.lnLogarithmBase = Math.log(this.logarithmBase), d.pixelPerUnit = (this.reversed ? 1 : - 1) * c * d.lnLogarithmBase / Math.log(Math.abs(b))) : d.pixelPerUnit = (this.reversed ? 1 : - 1) * c / Math.abs(b),
    ...
    F.prototype.calculateAxisParameters = function () {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters();
        ...
        if ('axisX' === this.type && c) {
          ...
          a ? (this.interval = 15, this.intervalType = 'minute') : b / (20 * T.minuteDuration) <= a ? (this.interval = 20, this.intervalType = 'minute') : b / (30 * T.minuteDuration) <= a ? (this.interval = 30, this.intervalType = 'minute') : b / (1 * T.hourDuration) <= a ? (this.interval = 1, this.intervalType = 'hour') : b / (2 * T.hourDuration) <= a ? (this.interval = 2, this.intervalType = 'hour') : b / (3 * T.hourDuration) <= a ? (this.interval = 3, this.intervalType = 'hour') : b / (6 * T.hourDuration) <= a ? (this.interval = 6, this.intervalType = 'hour') : b / (1 * T.dayDuration) <= a ? (this.interval = 1, this.intervalType = 'day') : b / (2 * T.dayDuration) <= a ? (this.interval = 2, this.intervalType = 'day') : b / (4 * T.dayDuration) <= a ? (this.interval = 4, this.intervalType = 'day') : b / (1 * T.weekDuration) <= a ? (this.interval = 1, this.intervalType = 'week') : b / (2 * T.weekDuration) <= a ? (this.interval = 2, this.intervalType = 'week') : b / (3 * T.weekDuration) <= a ? (this.interval = 3, this.intervalType = 'week') : b / (1 * T.monthDuration) <= a ? (this.interval = 1, this.intervalType = 'month') : b / (2 * T.monthDuration) <= a ? (this.interval = 2, this.intervalType = 'month') : b / (3 * T.monthDuration) <=
          a ? (this.interval = 3, this.intervalType = 'month') : b / (6 * T.monthDuration) <= a ? (this.interval = 6, this.intervalType = 'month') : (this.interval = b / (1 * T.yearDuration) <= a ? 1 : b / (2 * T.yearDuration) <= a ? 2 : b / (4 * T.yearDuration) <= a ? 4 : Math.floor(F.getNiceNumber(b / (a - 1), !0) / T.yearDuration), this.intervalType = 'year'));
        ...
        } else this.intervalType = this.valueType = 'number',
        null === this.minimum && (this.minimum = 'axisX' === this.type ? e - l / 2 : Math.floor(e / this.interval) * this.interval, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum)),
        null === this.maximum && (this.maximum = 'axisX' === this.type ? f + l / 2 : Math.ceil(f / this.interval) * this.interval, this.maximum = Math.max(this.maximum, null === this.sessionVariables.viewportMaximum || isNaN(this.sessionVariables.viewportMaximum) ? - Infinity : this.sessionVariables.viewportMaximum)),
    ...
    F.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      this.dataInfo.minDiff : e / b > this.logarithmBase ? e / b * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase, this.includeZero && (null === this.minimum || isNaN(this.minimum)) && 1 < b && (b = 1), this.includeZero && (null === this.maximum || isNaN(this.maximum)) && 1 > e && (e = 1)),
      this.intervalType = 'number',
      null === this.minimum && (this.minimum = 'axisX' === this.type ? b / Math.sqrt(f) : Math.pow(this.logarithmBase, this.interval * Math.floor(Math.log(b) / d / this.interval)), r(null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ?
      ...
      null === this.maximum && (this.maximum = 'axisX' === this.type ? e * Math.sqrt(f) :
    ...
    ca.prototype.render = function (a) {
      if (0 !== this.spacing || 0 !== this.options.lineThickness && ('undefined' !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
        ...
        if ('bottom' === this.scaleBreaks.parent._position || 'top' === this.scaleBreaks.parent._position) if (b = 1 === p % 2 ? (b.x << 0) + 0.5 : b.x << 0, h = 1 === p % 2 ? (e.x << 0) + 0.5 : e.x << 0, 'top' === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, m = this.chart.plotArea.y2 + p / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, m = this.chart.plotArea.y1 - p / 2 + 0.5 << 0, a *= - 1), this.bounds = {
          x1: b - p / 2,
          y1: e,
          x2: h + p / 2,
          y2: m
        }, this.ctx.moveTo(b, e), 'straight' === this.type || 'top' === this.scaleBreaks.parent._position && 0 >= a || 'bottom' === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, m),
        this.ctx.lineTo(h, m),
        this.ctx.lineTo(h, e);
          ...
          f = 0.5;
          n = (m - k) / a / 3;
          for (var q = 0; q < n; q++) this.ctx.bezierCurveTo(r + f * a, k + a, r + f * a, k + 2 * a, r, k + 3 * a),
          k += 3 * a,
          f *= - 1;
          ...
          f *= - 1;
          this.ctx.lineTo(r, k);
          for (q = 0; q < n; q++) this.ctx.bezierCurveTo(r + f * a, k - a, r + f * a, k - 2 * a, r, k - 3 * a),
          k -= 3 * a,
          f *= - 1
        } else {
          if ('zigzag' ===
          this.type) {
            ...
            r = b + a;
            n = (m - k) / a / 2;
            for (q = 0; q < n; q++) this.ctx.lineTo(r, k),
            r += 2 * f * a,
            k += 2 * a,
            f *= - 1;
            this.ctx.lineTo(r, k);
            r += h - b;
            for (q = 0; q < n + 1; q++) this.ctx.lineTo(r, k),
            r += 2 * f * a,
            k -= 2 * a,
            f *= - 1;
            this.ctx.lineTo(r + f * a, k + a)
          }
        } else if ('left' === this.scaleBreaks.parent._position || 'right' === this.scaleBreaks.parent._position) if (e = 1 === p % 2 ? (e.y << 0) + 0.5 : e.y << 0, m = 1 === p % 2 ? (b.y << 0) + 0.5 : b.y << 0, 'left' === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, h = this.chart.plotArea.x2 + p / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, h = this.chart.plotArea.x1 - p / 2 + 0.5 << 0, a *= - 1), this.bounds = {
          x1: b,
          y1: e - p / 2,
          x2: h,
          y2: m + p / 2
        }, this.ctx.moveTo(b, e), 'straight' === this.type || 'left' === this.scaleBreaks.parent._position && 0 >= a || 'right' === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(h, e),
        this.ctx.lineTo(h, m),
        this.ctx.lineTo(b, m);
         else if ('wavy' === this.type) {
          r = b;
          ...
          f = 0.5;
          n = (h - r) / a / 3;
          for (q = 0; q < n; q++) this.ctx.bezierCurveTo(r + a, k + f * a, r + 2 * a, k + f * a, r + 3 * a, k),
          r += 3 * a,
          f *= - 1;
    ...
    M.prototype.render = function () {
      ...
      if (0 < d) {
        ...
        this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0,
        ...
        this.bounds = {
         ...
         else if ('left' === this.parent._position || 'right' === this.parent._position) h = m = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0,
    ...
    Z.prototype.showAt = function (a) {
      ...
      } else if ('bottom' === this.parent._position) for (b = 0; b < d.axisX.length; b++) this.parent ===
      ...
      this.parent._position) for (b = 0; b < d.axisY2.length; b++) this.parent === d.axisY2[b] && (d.axisY2[b]._crosshairValue = a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum ? a : null);
      for (b = 0; b < d.axisX.length; b++) a = d.axisX[b]._crosshairValue,
      d.axisX[b].crosshair && (d.axisX[b].crosshair.enabled && !r(a) && a >= d.axisX[b].viewportMinimum && a <= d.axisX[b].viewportMaximum) && (d.axisX[b].showCrosshair(a), d.axisX[b].crosshair._updatedValue = a, this === d.axisX[b].crosshair && (c = !0));
      for (b = 0; b < d.axisX2.length; b++) a = d.axisX2[b]._crosshairValue,
      d.axisX2[b].crosshair && (d.axisX2[b].crosshair.enabled && !r(a) && a >= d.axisX2[b].viewportMinimum && a <= d.axisX2[b].viewportMaximum) && (d.axisX2[b].showCrosshair(a), d.axisX2[b].crosshair._updatedValue = a, this === d.axisX2[b].crosshair && (c = !0));
      ...
      for (b = 0; b < d.axisY2.length; b++) a = d.axisY2[b]._crosshairValue,
      d.axisY2[b].crosshair && (d.axisY2[b].crosshair.enabled && !r(a) && a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum) && (d.axisY2[b].showCrosshair(a), d.axisY2[b].crosshair._updatedValue = a, this === d.axisY2[b].crosshair && (c = !0));
    ...
    Z.prototype.render = function (a, d, c) {
      ...
      q.lineWidth = p;
      q.save();
      this.labelFontSize = Math.abs(r(this.options.labelFontSize) ? this.parent.labelFontSize :
      this.labelFontSize);
      ...
      if (this.snapToDataPoint) {
        ...
        if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
          ...
          this.parent._position || 'right' === this.parent._position) s = this.parent.convertPixelToValue({
            y: d
          });
          for (var x = 0; x < this.parent.dataSeries.length; x++) (v = this.parent.dataSeries[x].getDataPointAtX(s, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[x], null !== v.dataPoint.y && v.dataSeries.visible && n.push(v));
          v = null;
          ...
          x = 0;
          if ('rangeBar' === n[0].dataSeries.type || 'error' ===
          n[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(n[x].dataPoint.y[0])), u = 0, s = 0; s < n.length; s++) if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (var z = 0; z < n[s].dataPoint.y.length; z++) u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[z])),
          u < v && (v = u, x = s);
           else u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y)),
          u < v && (v = u, x = s);
           else if ('stackedBar' === n[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), y = u = 0, s = x = 0; s <
          n.length; s++) if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (z = 0; z < n[s].dataPoint.y.length; z++) u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[z])),
          u < v && (v = u, x = s);
           else y += n[s].dataPoint.y,
          u = Math.abs(a - this.parent.convertValueToPixel(y)),
          u < v && (v = u, x = s);
           else if ('stackedBar100' === n[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), C = y = u = 0, s = 0; s < n.length; s++) if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (z = 0; z < n[s].dataPoint.y.length; z++) u = Math.abs(a -
          this.parent.convertValueToPixel(n[s].dataPoint.y[z])),
          u < v && (v = u, x = s);
           else y += n[s].dataPoint.y,
          ...
          u < v && (v = u, x = s);
           else for (v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), s = x = u = 0; s < n.length; s++) if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (z = 0; z < n[s].dataPoint.y.length; z++) u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[z])),
          u < v && (v = u, x = s);
           else u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y)),
          u < v && (v = u, x = s);
          z = n[x];
          if ('bottom' === this.parent._position || 'top' === this.parent._position) {
            ...
            if ('rangeBar' === this.parent.dataSeries[x].type || 'error' === this.parent.dataSeries[x].type) {
              ...
              for (s = u = 0; s < z.dataPoint.y.length; s++) u = Math.abs(a - this.parent.convertValueToPixel(z.dataPoint.y[s])),
              u < v && (v = u, b = s);
              m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(z.dataPoint.y[b]) <<
              0) + 0.5 : this.parent.convertValueToPixel(z.dataPoint.y[b]) << 0;
              this.value = z.dataPoint.y[b];
              k.text = this.labelFormatter ? this.labelFormatter({
                chart: this.chart,
                axis: this.parent.options,
                crosshair: this.options,
                value: z.dataPoint.y[b]
              }) : r(this.options.label) ? ea(c ? c : z.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo) : this.label
            } else if ('stackedBar' === this.parent.dataSeries[x].type) {
              v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y));
              y = u = 0;
              for (s = x; 0 <= s; s--) y += n[s].dataPoint.y,
              u = Math.abs(a -
              this.parent.convertValueToPixel(y)),
              u < v && (v = u, b = s);
            ...
            } else m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(z.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(z.dataPoint.y) << 0,
            ...
            C = !1;
            if (this.parent.labels) for (n = Math.ceil(this.parent.interval), s = 0; s < this.parent.viewportMaximum; s += n) if (this.parent.labels[s]) C = !0;
             else {
              C = !1;
              break
            }
            if (C) {
              if ('axisX' === this.parent.type) for (s = this.parent.convertPixelToValue({
                y: d
              ...
              crosshair: this.options,
              value: z.dataPoint.x
            }) : r(this.options.label) ? Aa(z.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) :
            this.label : 'number' === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
              chart: this.chart,
              axis: this.parent.options,
              crosshair: this.options,
              value: z.dataPoint.x
            }) : r(this.options.label) ? ea(z.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
          ...
          r(this.options.label) ? Aa(z.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : 'number' === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: z.dataPoint.x
          ...
          x = 0;
          if ('rangeColumn' === n[0].dataSeries.type || 'rangeArea' === n[0].dataSeries.type || 'error' === n[0].dataSeries.type || 'rangeSplineArea' === n[0].dataSeries.type || 'candlestick' === n[0].dataSeries.type || 'ohlc' === n[0].dataSeries.type || 'boxAndWhisker' === n[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), s = u = 0; s < n.length; s++) if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (z = 0; z < n[s].dataPoint.y.length; z++) u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[z])),
          u < v && (v = u, x = s);
           else u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y)),
          u < v && (v = u, x = s);
           else if ('stackedColumn' === n[0].dataSeries.type || 'stackedArea' === n[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), s = y = u = 0; s < n.length; s++) if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (z = 0; z <
          n[s].dataPoint.y.length; z++) u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[z])),
          u < v && (v = u, x = s);
           else y += n[s].dataPoint.y,
          u = Math.abs(d - this.parent.convertValueToPixel(y)),
          u < v && (v = u, x = s);
           else if ('stackedColumn100' === n[0].dataSeries.type || 'stackedArea100' === n[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), s = C = y = u = 0; s < n.length; s++) if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (z = 0; z < n[s].dataPoint.y.length; z++) u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[z])),
          u < v && (v = u, x = s);
           else y += n[s].dataPoint.y,
          C = n[s].dataPoint.x.getTime ? n[s].dataPoint.x.getTime() : n[s].dataPoint.x,
          C = 100 * (y / n[s].dataSeries.plotUnit.dataPointYSums[C]),
          ...
          u < v && (v = u, x = s);
           else for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), s = u = 0; s < n.length; s++) if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (z = 0; z < n[s].dataPoint.y.length; z++) u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[z])),
          u < v && (v = u, x = s);
           else u = Math.abs(d -
          this.parent.convertValueToPixel(n[s].dataPoint.y)),
          u < v && (v = u, x = s);
          z = n[x];
          b = 0;
          if ('rangeColumn' === this.parent.dataSeries[x].type || 'rangeArea' === this.parent.dataSeries[x].type || 'error' === this.parent.dataSeries[x].type || 'rangeSplineArea' === this.parent.dataSeries[x].type || 'candlestick' === this.parent.dataSeries[x].type || 'ohlc' === this.parent.dataSeries[x].type || 'boxAndWhisker' === this.parent.dataSeries[x].type) {
            ...
            for (s = u = 0; s < z.dataPoint.y.length; s++) u = Math.abs(d - this.parent.convertValueToPixel(z.dataPoint.y[s])),
            u < v && (v = u, b = s);
          ...
          this.parent.dataSeries[x].type || 'stackedArea' === this.parent.dataSeries[x].type) {
            ...
            this.value = C
          } else 'waterfall' === this.parent.dataSeries[x].type ? (w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(z.dataSeries.dataPointEOs[z.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(z.dataSeries.dataPointEOs[z.index].cumulativeSum) <<
          0, k.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: z.dataSeries.dataPointEOs[z.index].cumulativeSum
          }) : r(this.options.label) ? ea(c ? c : z.dataSeries.dataPointEOs[z.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = z.dataSeries.dataPointEOs[z.index].cumulativeSum) : (w = 1 === q.lineWidth % 2 ? (r(a) ? d : this.parent.convertValueToPixel(z.dataPoint.y) << 0) + 0.5 : r(a) ? d : this.parent.convertValueToPixel(z.dataPoint.y) <<
          0, k.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: c ? c : z.dataPoint.y
          }) : r(this.options.label) ? ea(c ? c : z.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = z.dataPoint.y);
          f = h = w;
          b = this.chart.plotArea.x1;
          e = this.chart.plotArea.x2;
          this.bounds = {
        ...
        'bottom' === this.parent._position && this.parent.lineCoordinates.y2 -
        k.fontSize / 2 + k.measureText().height > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.height + k.fontSize / 2 + 2),
        b >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && e <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && (0 < p && (q.moveTo(b, f), q.lineTo(e, h), q.stroke(), this._hidden = !1), q.restore());
        ...
        h >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && (0 < p && (q.moveTo(b, f), q.lineTo(e, h), q.stroke(), this._hidden = !1), q.restore())
      } else {
        if ('bottom' ===
        this.parent._position || 'top' === this.parent._position) b = e = m = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0,
        f = this.chart.plotArea.y1,
        h = this.chart.plotArea.y2,
        this.bounds = {
          x1: b - p / 2,
         ...
         else if ('left' === this.parent._position || 'right' === this.parent._position) f = h = w = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0,
        b = this.chart.plotArea.x1,
        e = this.chart.plotArea.x2,
        this.bounds = {
          x1: b,
        ...
        if ('xySwapped' === this.chart.plotInfo.axisPlacement) if ('left' === this.parent._position || 'right' === this.parent._position) {
          ...
          }) : r(this.options.label) ? Aa(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label : 'number' === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: c ? c : this.parent.convertPixelToValue(d)
          ...
          if (C) {
            ...
            crosshair: this.options,
            value: c ? c : this.parent.convertPixelToValue(a)
          }) : r(this.options.label) ? Aa(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label : 'number' === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: c ? c : 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : ''
          }) : r(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) :
          this.label);
          k.x = b - k.measureText().width / 2;
          k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width);
          k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1);
        ...
        k.y = d + k.fontSize / 2 - k.measureText().height / 2 + 2,
        k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.measureText().height + k.fontSize / 2),
        'left' === this.parent._position ? k.x = this.parent.lineCoordinates.x2 -
    ...
    X.prototype._updateToolTip = function (a, d, c) {
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (this.shared && this.enabled && 'none' !== this.chart.plotInfo.axisPlacement) {
          if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX) for (var v = 0; v < this.chart.axisX.length; v++) {
              for (var h = this.chart.axisX[v].convertPixelToValue({
                y: d
              }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++) (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b], null !== k.dataPoint.y && m.push(k));
              k = null
            }
            if (this.chart.axisX2) for (v = 0; v < this.chart.axisX2.length; v++) {
              ...
              k = null;
              for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++) (k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b], null !== k.dataPoint.y && m.push(k));
              k = null
            }
          } else {
            m = [
            ];
            if (this.chart.axisX) for (v = 0; v < this.chart.axisX.length; v++) for (h = this.chart.axisX[v].convertPixelToValue({
              x: a
            }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++) (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b], null !== k.dataPoint.y && m.push(k));
            if (this.chart.axisX2) for (v = 0; v < this.chart.axisX2.length; v++) for (h = this.chart.axisX2[v].convertPixelToValue({
              x: a
            }), k = null, b = 0; b < this.chart.axisX2[v].dataSeries.length; b++) (k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b], null !== k.dataPoint.y && m.push(k))
          }
          ...
          if (b = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = b.dataPointIndex,
          this.currentSeriesIndex = b.dataSeries.index;
           else if (w) if (b = $a(a, d, this.chart._eventManager.ghostCtx), 0 < b && 'undefined' !== typeof this.chart._eventManager.objectMap[b]) {
          ...
          if (0 <= this.currentSeriesIndex) {
            ...
            if (0 <= this.currentDataPointIndex) b = e.dataPoints[this.currentDataPointIndex],
            k.dataSeries = e,
            k.dataPoint = b,
        ...
        if (0 < f.length) {
          if (this.highlightObjects(f), this.enabled) {
            ...
            if (null !== c) {
              ...
              if (this.isToolTipDefinedInData && r(this.options.content) && r(this.options.contentFormatter)) for (h = this.contentDiv.getElementsByTagName('span'), b = 0; b < h.length; b++) h[b] && (h[b].style.color = h[b].getAttribute('data-color'));
              h = !1;
              ...
              try {
                ...
                this.borderColor = 'waterfall' === f[0].dataSeries.type ?
    ...
    X.prototype.highlightObjects = function (a) {
      ...
      for (c = 0; c < a.length; c++) {
        ...
        if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && 'dataPoint' === e.objectType) {
          ...
          oa(d, e.funnelSection, 0.3, 'white') : 'candlestick' === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, Math.min(e.y2, e.y3)), d.lineTo(e.x3 - b, Math.min(e.y1, e.y4)), d.stroke(), d.beginPath(), d.moveTo(e.x3 - b, Math.max(e.y1, e.y4)), d.lineTo(e.x3 - b, Math.max(e.y2, e.y3)), d.stroke(), V(d, e.x1, Math.min(e.y1, e.y4), e.x2, Math.max(e.y1, e.y4), 'transparent', 2 * e.borderThickness, e.color, !1, !1, !1, !1), d.globalAlpha = 1) : 'ohlc' === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, e.y2), d.lineTo(e.x3 - b, e.y3), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y1), d.lineTo(e.x1, e.y1), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y4), d.lineTo(e.x2, e.y4), d.stroke(), d.globalAlpha = 1) : 'boxAndWhisker' === b.type ? (d.save(), d.globalAlpha = 1, d.strokeStyle = e.stemColor, d.lineWidth = 2 * e.stemThickness, 0 < e.stemThickness && (d.beginPath(), d.moveTo(e.x3, e.y2 + e.borderThickness / 2), d.lineTo(e.x3, e.y1 + e.whiskerThickness / 2), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y4 - e.whiskerThickness / 2), d.lineTo(e.x3, e.y3 - e.borderThickness / 2), d.stroke()), d.beginPath(), V(d, e.x1 - e.borderThickness / 2, Math.max(e.y2 + e.borderThickness / 2, e.y3 + e.borderThickness / 2), e.x2 + e.borderThickness / 2, Math.min(e.y2 - e.borderThickness / 2, e.y3 - e.borderThickness / 2), 'transparent', e.borderThickness, e.color, !1, !1, !1, !1), d.globalAlpha = 1, d.strokeStyle = e.whiskerColor, d.lineWidth = 2 * e.whiskerThickness, 0 < e.whiskerThickness && (d.beginPath(), d.moveTo(Math.floor(e.x3 -
    ...
    X.prototype.getToolTipInnerHTML = function (a) {
      ...
      d = this.contentFormatter ? this.contentFormatter(a) : this.content(a);
        ...
        '<span data-color=\'"' + (this.options.fontColor ? '' : '\'{color}\'') + '"\'>{name}:</span><br/>Minimum: &nbsp;&nbsp;{y[0]}<br/>Q1: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{y[1]}<br/>Q2: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{y[4]}<br/>Q3: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{y[2]}<br/>Maximum: &nbsp;{y[3]}'), null === d && (d = ''), !0 === this.reversed ? (d = this.chart.replaceKeywordsWithValue(f, b, c, e) + d, h < a.length - 1 && (d = '</br>' + d)) : (d += this.chart.replaceKeywordsWithValue(f, b, c, e), h < a.length - 1 && (d += '</br>')));
        null !== d && (d = r + d)
      } else {
        c = a[0].dataSeries;
        b = a[0].dataPoint;
    ...
    X.prototype.showAtX = function (a, d) {
      ...
      if (this.shared) for (var h = 0; h < this.chart.data.length; h++) c = this.chart.data[h],
      (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !r(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b));
       else c = this.chart.data[d],
      (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !r(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b));
      if (0 < f.length) {
        for (h = 0; h < f.length; h++) if (b = f[h], b.dataPoint.x < b.dataSeries.axisX.viewportMinimum || b.dataPoint.x > b.dataSeries.axisX.viewportMaximum || b.dataPoint.y < b.dataSeries.axisY.viewportMinimum || b.dataPoint.y > b.dataSeries.axisY.viewportMaximum) e = !0;
         else {
          e = !1;
          break
        }
        ...
        if (null !== h) {
          ...
          if (this.isToolTipDefinedInData && r(this.options.content) && r(this.options.contentFormatter)) for (b = this.contentDiv.getElementsByTagName('span'), h = 0; h < b.length; h++) b[h] && (b[h].style.color = b[h].getAttribute('data-color'));
          h = !1;
          'none' === this.container.style.display && (h = !0, this.container.style.display = 'block');
          try {
            this.contentDiv.style.background = this.backgroundColor ? this.backgroundColor : w ? 'rgba(255,255,255,.9)' : 'rgb(255,255,255)',
          ...
          'pie' === f[0].dataSeries.type || 'doughnut' === f[0].dataSeries.type || 'funnel' === f[0].dataSeries.type || 'pyramid' === f[0].dataSeries.type ? c = mouseX - 10 - this.container.clientWidth : (c = 'bar' === f[0].dataSeries.type || 'rangeBar' === f[0].dataSeries.type || 'stackedBar' === f[0].dataSeries.type || 'stackedBar100' === f[0].dataSeries.type ?
          f[0].dataSeries.axisY.convertValueToPixel(f[0].dataPoint.y) - this.container.clientWidth << 0 : f[0].dataSeries.axisX.convertValueToPixel(f[0].dataPoint.x) - this.container.clientWidth << 0, c -= 10);
          ...
          f = - f + 10;
          0 < f + this.container.clientHeight + 5 && (f -=
          f + this.container.clientHeight + 5 - 0);
    ...
    ha.prototype.animate = function (a, d, c, b, e) {
      ...
      for (a = [
      ]; 0 < this.animations.length; ) if (d = this.animations.shift(), c = (new Date).getTime(), b = 0, d.startTime <= c && (b = e(Math.min(c - d.startTime, d.duration), 0, 1, d.duration), b = Math.min(b, 1), isNaN(b) || !isFinite(b)) && (b = 1), 1 > b && a.push(d), d.animationCallback(b), 1 <= b && d.onComplete) d.onComplete();
      this.animations = a;
...
document.createElement('canvas').getContext || function () {
  ...
  function X(a) {
    ...
    switch (a.propertyName) {
      ...
      case 'height':
        ...
        b.firstChild.style.height = b.clientHeight +
        'px'
    }
  }
  function Y(a) {
  ...
  U.init();
  for (var v = [
  ], d = 0; 16 > d; d++) for (var B = 0; 16 > B; B++) v[16 * d + B] = d.toString(16) + B.toString(16);
  var Z = {
    aliceblue: '#F0F8FF',
    antiquewhite: '#FAEBD7',
    aquamarine: '#7FFFD4',
  ...
  d.drawImage = function (a, b) {
    ...
    n = l,
    h = u;
     else if (9 == arguments.length) r = arguments[1],
    y = arguments[2],
    n = arguments[3],
    h = arguments[4],
    c = arguments[5],
